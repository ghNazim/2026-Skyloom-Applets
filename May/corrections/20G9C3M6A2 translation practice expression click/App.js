const App = () => {
  ...
  const [hasInteractedWithDnd, setHasInteractedWithDnd] = useState(false);
  ...
  const navText = useMemo(() => {
    ...
    if (currentStep === 4) {
      ...
      const currentSimplifyConfig = currentQuestion.simplify.phases[simplifyPhase];
      return simplifyComplete
        ? APP_DATA.steps[4].navTextDone
        : currentSimplifyConfig && currentSimplifyConfig.type === "r"
          ? APP_DATA.steps[4].navTextRearrange
          : APP_DATA.steps[4].navTextSimplify;
    }
    return "";
  }, [
    currentStep,
    ...
    React.createElement(
      ...
      currentStep >= 2
        ? React.createElement(MainCanvas, {
            ...
            hasInteractedWithDnd: hasInteractedWithDnd,
