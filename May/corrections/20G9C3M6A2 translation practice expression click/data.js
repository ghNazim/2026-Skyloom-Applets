    ...
    app: {
      ...
      textSplash: {
        ...
        content:
          ...
          "x   →   ( x <span class=\"formula-minus\">-</span> <pr>a</pr> )<br>" +
          "y   →   ( y <span class=\"formula-minus\">-</span> <yl>b</yl> )<br>" +
      ...
      steps: {
        ...
        3: {
          ...
          feedbackText:
            ...
            "by replacing x → ( x <span class=\"formula-minus\">-</span> <pr>a</pr> )  and  y → ( y <span class=\"formula-minus\">-</span> <yl>b</yl> ).",
        },
        4: {
          navTextSimplify: "Tap the highlighted box to simplify",
          navTextRearrange: "Tap the highlighted box to rearrange terms",
      ...
      steps: {
        ...
        3: {
          ...
          feedbackText:
            ...
            "dengan mengganti x → ( x <span class=\"formula-minus\">-</span> <pr>a</pr> )  dan  y → ( y <span class=\"formula-minus\">-</span> <yl>b</yl> ).",
        },
        4: {
          navTextSimplify: "Ketuk kotak yang disorot untuk menyederhanakan",
          navTextRearrange: "Ketuk kotak yang disorot untuk menyusun ulang suku",
