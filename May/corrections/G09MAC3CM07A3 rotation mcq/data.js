  ...
  en: {
    app: {
      start: {
        ...
        text:
          "Let's practice what we have learned<br>so far about rotation.<br><br><br>Tap 'START' to begin.",
        buttonText: "START",
      },
      finish: {
      ...
      step4: {
        ...
        navIncorrect: "Tap 'Retry' to answer again.",
      ...
      mcq: {
        ...
        4: {
          ...
          wrongFeedback:
            "Not quite! The object is rotating in the direction opposite to the clock's hands.",
          correctFeedback:
            "Correct! The object is rotating in the direction opposite to the clock's hands.",
        },
      },
    },
  },
  id: {
    app: {
      start: {
        ...
        text:
          "Mari berlatih apa yang telah kita pelajari<br>tentang rotasi sejauh ini.<br><br><br>Ketuk 'MULAI' untuk memulai.",
        buttonText: "MULAI",
      },
      finish: {
      ...
      step4: {
        ...
        navIncorrect: "Ketuk 'Coba Lagi' untuk menjawab lagi.",
      ...
      mcq: {
        ...
        4: {
          ...
          options: ["Searah jarum jam", "Berlawanan arah jarum jam"],
          optionFlex: "column",
          ans: "Berlawanan arah jarum jam",
          arrowDirection: "anticlockwise",
          wrongFeedback:
            "Belum tepat! Benda berputar berlawanan arah dengan jarum jam.",
          correctFeedback:
            "Benar! Benda berputar berlawanan arah dengan jarum jam.",
        },
      },
    },
  },
