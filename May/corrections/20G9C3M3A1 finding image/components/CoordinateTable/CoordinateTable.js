    ...
    if (!row4RevealReady || !state || state.mode === "hidden") {
      ...
      content = React.createElement(
        ...
        React.createElement(
          "span",
          {
            className: partClass(state.showPlus && state.showTrans) + " reveal-trans-token",
            ref: (el) => {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          {
            className: "coord-table-cell coord-table-label coord-table-label-object",
            ref: (el) => {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "coord-table-cell coord-table-label coord-table-label-translation",
            ref: (el) => {
            ...
            : step === 3
              ? React.createElement(
                  "span",
                  {
                    ...
                    ref: (el) => {
                      if (cellRefs) cellRefs.row3XValue = el;
                    },
                  },
                  "+6",
                )
            ...
            : step === 3
              ? React.createElement(
                  "span",
                  {
                    className: textClass(true),
                    ref: (el) => {
                      if (cellRefs) cellRefs.row3YValue = el;
                    },
                  },
                  "+2",
                )
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          {
            className: "coord-table-cell coord-table-label coord-table-label-image",
            ref: (el) => {
