...
const DATA = {
  en: {
    app: {
      ...
      feedback: {
        overlap:
          "The two triangles overlap exactly on top of each other. Hence, they are congruent.",
      },
      actions: {
  ...
  id: {
    app: {
      ...
      feedback: {
        overlap:
          "Kedua segitiga bertumpuk tepat di atas satu sama lain. Oleh karena itu, keduanya kongruen.",
      },
      actions: {
