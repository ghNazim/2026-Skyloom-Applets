    ...
    app: {
      ...
      steps: {
        1: {
          ...
          introText:
            "Translation is a transformation that moves every point of a shape the <y>same distance</y> in the<br> <y>same direction</y>.",
          labelPreimage: "Object",
          labelImage: "Image",
          textPreimage:
            "The original figure before the translation is called <y>Object</y>.<br><br>Object points are usually named using capital letters such as <y>A, B, C</y>, and so on.",
          textImage:
      ...
      navigation2: {
        summarize: "Summarize",
        prompt: "Tap each button to explore properties of translation",
      },
    },
  },
  id: {
    app: {
      ...
      steps: {
        1: {
          ...
          introText:
            "Translasi adalah transformasi yang memindahkan setiap titik pada bangun dengan jarak yang sama ke arah yang sama.",
          labelPreimage: "Objek",
          labelImage: "Bayangan",
          textPreimage:
            "Bangun asli sebelum translasi disebut <y>Objek</y>.<br><br>Titik objek biasanya dinamai dengan huruf kapital seperti <y>A, B, C</y>, dan seterusnya.",
          textImage:
      ...
      navigation2: {
        summarize: "Ringkas",
        prompt: "Ketuk setiap tombol untuk menjelajahi sifat-sifat translasi",
      },
    },
  },
};
