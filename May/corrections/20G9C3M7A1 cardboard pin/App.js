const App = () => {
  ...
  const [summarySequenceDone, setSummarySequenceDone] = useState(false);
  ...
  const handleSummarySequenceComplete = useCallback(() => {
    setSummarySequenceDone(true);
  }, []);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      currentStep === 6
        ? React.createElement(SummaryCanvas, {
            onSequenceComplete: handleSummarySequenceComplete,
          })
    ...
    React.createElement(
      ...
      React.createElement(Navigation, {
        ...
        completionVisible: currentStep !== 6 || summarySequenceDone,
