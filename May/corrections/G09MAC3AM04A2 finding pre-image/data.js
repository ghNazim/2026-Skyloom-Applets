    ...
    app: {
      ...
      steps: {
        ...
        3: {
          ...
          navTextDone: "Tap » to see another question",
        },
        4: {
          questionText:
            "The image of a line segment has endpoints M'(6,5) and N'(9,7).<br> It was translated by (+2,+3). Find object.",
          navText: "Drag the line segment to the object position",
          navTextDone: "Tap » to see another question",
          feedbackWrong: "Oops! Try again",
          feedbackCorrectDone:
            "Correct!\nYou moved the figure back to its object position.",
          pointMPrimeLabel: "M' (6,5)",
          pointNPrimeLabel: "N' (9,7)",
        },
        5: {
          questionText:
            "Given image has translated 5 units left and 2 units upwards. Find the object.",
          navTextDragA: "Drag point A to the object position",
          navTextDragB: "Drag point B to the object position",
          navTextDragC: "Drag point C to the object position",
          navTextDragD: "Drag point D to the object position",
          navTextDone: "Tap » to see another question",
          feedbackWrong: "Oops! Try again",
          feedbackCorrectDone:
        ...
        6: {
          questionText:
            "Given image has translated 4 units to the right and 2 units downward. Find the object.",
