  ...
  en: {
    app: {
      ...
      steps: {
        ...
        2: {
          questionText: "Let's build another triangle whose corresponding sides are proportional.",
          ...
          proportionalText: "Three pairs of corresponding\nsides are proportional",
        },
        3: {
  ...
  id: {
    app: {
      ...
      steps: {
        ...
        2: {
          questionText: "Mari bangun segitiga lain yang sisi-sisi bersesuaiannya proporsional.",
          navText: "Ketuk tombol untuk memilih rasio sisi-sisi yang bersesuaian.",
          questionAfterRatio: "Hubungan antara sisi-sisi yang bersesuaian",
          navAfterAnimation: "Ketuk \u00BB untuk membangun segitiga kuning.",
          proportionalText: "Tiga pasang sisi yang bersesuaian\nproporsional",
        },
        3: {
          ...
          navDone: "Ketuk tombol untuk memeriksa kedua segitiga sebangun.",
        ...
        5: {
          ...
          panelText:
            "Jika tiga pasang sisi yang bersesuaian proporsional, maka segitiga-segitiga tersebut sebangun.",
          nameButtonText: "Nama",
          sssName: "Kesebangunan SSS",
          questionRevealed: "Ini disebut kesebangunan SSS.",
