...
const DATA = {
  ...
  id: {
    app: {
      ...
      question: {
        text:
          'Segitiga PQR ditransformasi untuk menghasilkan bayangan P\u2019Q\u2019R\u2019.<br>Diberikan <span id="highlight-p" class="orange-bg fly-source">P (2,1)</span>, <span id="highlight-q" class="orange-bg fly-source">Q (4,3)</span>, <span id="highlight-p-prime" class="cyan-bg fly-source">P\u2019 (1,-2)</span>, dan <span id="highlight-r-prime" class="cyan-bg fly-source">R\u2019 (4,-3)</span>. Tentukan koordinat <span id="highlight-r-solve" class="orange-bg">R</span> dan <span id="highlight-qprime-solve" class="cyan-bg">Q\u2019</span>.',
        textPlain:
          "Segitiga PQR ditransformasi untuk menghasilkan bayangan P\u2019Q\u2019R\u2019.<br> Diberikan P (2,1), Q (4,3), P\u2019 (1,-2), dan R\u2019 (4,-3). Tentukan koordinat R dan Q\u2019.",
        textStep9:
          "Segitiga PQR ditransformasi untuk menghasilkan bayangan P\u2019Q\u2019R\u2019.<br> Diberikan P (2,1), Q (4,3), P\u2019 (1,-2), dan R\u2019 (4,-3). <span id=\"highlight-solve-phrase\" class=\"purple-bg\">Tentukan koordinat R dan Q\u2019.</span>",
      },
      graph: {
        labelP: "P (2,1)",
        labelQ: "Q (4,3)",
