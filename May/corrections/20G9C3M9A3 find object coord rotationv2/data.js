...
const DATA = {
  en: {
    app: {
      ...
      question: {
        text:
          'A line segment is rotated <span id="highlight-rotation" class="purple-bg">270\u00b0 clockwise</span> about the origin, resulting in endpoints <br><span id="highlight-a-prime" class="cyan-bg fly-source">A\u2019 (-2,3)</span> and <span id="highlight-b-prime" class="cyan-bg fly-source">B\u2019 (-4,1)</span>. <span id="highlight-find" class="orange-bg">Find the original line segment.</span>',
        textPlain:
          "A line segment is rotated 270\u00b0 clockwise about the origin, resulting in endpoints <br>A\u2019 (-2,3) and B\u2019 (-4,1). Find the original line segment.",
      },
      question2: {
        textPlain:
          "A rectangle ABCD was rotated 180\u00b0 clockwise about the origin to produce the image A\u2019B\u2019C\u2019D\u2019.<br> Find the object coordinates.",
      },
      graph: {
        labelAPrime: "A\u2019 (-2,3)",
        labelBPrime: "B\u2019 (-4,1)",
      ...
      rotatePanel2: {
        text:
          "<y>A (2,-1)</y>, <y>B (2,-4)</y>, <y>C (-1,-4)</y>, and<br> <y>D (-1,-1)</y> are the object points.",
        buttonText: "Rotate!",
      },
      dnd: {
        items: {
  ...
  id: {
    app: {
      ...
      question: {
        text:
          'Sebuah ruas garis dirotasi <span id="highlight-rotation" class="purple-bg">270\u00b0 searah jarum jam</span> terhadap titik asal, sehingga titik ujungnya menjadi <br><span id="highlight-a-prime" class="cyan-bg fly-source">A\u2019 (-2,3)</span> dan <span id="highlight-b-prime" class="cyan-bg fly-source">B\u2019 (-4,1)</span>. <span id="highlight-find" class="orange-bg">Temukan ruas garis aslinya.</span>',
        textPlain:
          "Sebuah ruas garis dirotasi 270\u00b0 searah jarum jam terhadap titik asal, sehingga titik ujungnya menjadi <br>A\u2019 (-2,3) dan B\u2019 (-4,1). Temukan ruas garis aslinya.",
      },
      question2: {
        textPlain:
          "Persegi panjang ABCD dirotasi 180\u00b0 searah jarum jam terhadap titik asal sehingga menghasilkan bayangan A\u2019B\u2019C\u2019D\u2019.<br> Temukan koordinat objek.",
      },
      graph: {
        labelAPrime: "A\u2019 (-2,3)",
        labelBPrime: "B\u2019 (-4,1)",
      ...
      rotatePanel2: {
        text:
          "<y>A (2,-1)</y>, <y>B (2,-4)</y>, <y>C (-1,-4)</y>, dan<br> <y>D (-1,-1)</y> adalah titik objek.",
        buttonText: "Rotasi!",
      },
      dnd: {
        items: {
