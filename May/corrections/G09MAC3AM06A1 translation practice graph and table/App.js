const App = () => {
  ...
  const [step2To3TransferId, setStep2To3TransferId] = useState(0);
  ...
  const handleStep2To3Ready = useCallback(() => {
    setCurrentStep(3);
  }, []);

  const handleStep2To3Complete = useCallback(() => {
    setNavAnimating(false);
  }, []);
  ...
  const navText = useMemo(() => {
    ...
    if (currentStep === 5) {
      ...
      if (step5Phase === "mcq" || step5Phase === "wrong") {
    ...
    if (currentStep === 8) {
      ...
      if (step8Phase === "mcq" || step8Phase === "wrong") {
    ...
    if (currentStep === 9) {
      ...
      if (step9Phase === "mcq" || step9Phase === "wrong") {
        return APP_DATA.steps[9].navText;
      }
      return "";
    }
  ...
  const handleNext = () => {
    if (typeof playSound === "function") playSound("click");
    setNudgePositions([]);
    if (navAnimating || isNextDisabled) return;
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(MainCanvas, {
        ...
        step2To3TransferId: step2To3TransferId,
        onStep2To3Ready: handleStep2To3Ready,
        onStep2To3Complete: handleStep2To3Complete,
      }),
    ),
    React.createElement(
      "div",
