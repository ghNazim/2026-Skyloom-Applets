...
const PreImageImageTable = ({
  ...
  const renderCoordCell = (opts) => {
    ...
    const hideContent = hiddenCoordCells && hiddenCoordCells[key];
    ...
    if (hideContent) {
      content = null;
    } else if (fillExpr && fillExpr.active) {
  ...
  const rows = [
    ...
    },
    {
      ...
      img: renderCoordCell({
        ...
        isOutlined: outlinedCells.qPrime,
      }),
    },
    {
      pre: renderCoordCell({
