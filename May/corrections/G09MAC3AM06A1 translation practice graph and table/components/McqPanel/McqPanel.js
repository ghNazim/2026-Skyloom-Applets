const McqPanel = ({
  ...
  const canRetryAfterWrong = showFeedback && feedbackType === "wrong" && !disabled;

  return React.createElement(
    "div",
    { className: "mcq-panel" + (className ? " " + className : "") },
    title
      ? React.createElement(
          "div",
    ...
    React.createElement(
      ...
      options.map((opt, index) => {
        let cls = "mcq-option";
        const isDisabled =
          disabled || (selectedIndex !== null && !canRetryAfterWrong);
