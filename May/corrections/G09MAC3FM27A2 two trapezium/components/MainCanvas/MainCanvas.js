...
var MainCanvas = function (props) {
  ...
  function applyCompletedStepState(completedStep) {
    ...
    setCalcAngle(null); setCalcPhase(0); setYellowAngles([]);
  ...
  function renderHotspots() {
    ...
    return available.map(function (vk) {
      ...
      var ringStroke = isWrong ? "rgba(255,80,80,0.8)" : "rgba(255,255,255,0.8)";
      var innerFill = isWrong ? "rgba(255,50,50,0.55)" : "rgba(255,255,255,0.38)";
  ...
  function renderCalcText() {
    ...
    var calcTextOffset = calcPhase === 2 && (calcAngle === "C" || calcAngle === "D") ? 20 : 0;
    var pos = _angleLabelPos(calcAngle, calcTextOffset);
