    ...
    app: {
      steps: {
        ...
        4: {
          ...
          tapCorresponding: "Shout out the side length in {polygon} that corresponds to {side}.",
        ...
        6: {
          ...
          wrongFeedback: "Not quite! Use the order of the vertices in the congruence statement to identify the angle that corresponds to \u2220{angle}. Then try again.",
    ...
    app: {
      steps: {
        ...
        6: {
          ...
          wrongFeedback: "Belum tepat! Gunakan urutan titik pada pernyataan kongruen untuk mengidentifikasi sudut yang bersesuaian dengan \u2220{angle}. Lalu coba lagi.",
