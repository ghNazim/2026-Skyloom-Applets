...
const TRI_ORIGINAL_COLOR = "#46c5ce";
...
const TriangleDragGraphPanel = ({
  ...
  const renderFigure = (
    ...
    return React.createElement(
      "g",
      { key: keyPrefix, opacity: opacity != null ? opacity : 1 },
      els,
    );
  };
  ...
  const showSolvedOriginal =
    !isDragging &&
    !snapAnim &&
    !dragEnabled &&
    !snapBackActive &&
    (offset.dx !== 0 || offset.dy !== 0) &&
    figureColor !== TRI_ORIGINAL_COLOR;
  const ghostColor = showSolvedOriginal ? TRI_ORIGINAL_COLOR : GHOST_COLOR;
  const ghostOpacity = showSolvedOriginal ? 1 : 0.3;
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      axisLabels,
      showGhost
        ? renderFigure(0, 0, ghostColor, true, "ghost", {
            pointerEvents: "none",
          }, ghostOpacity)
        : null,
      renderFigure(
