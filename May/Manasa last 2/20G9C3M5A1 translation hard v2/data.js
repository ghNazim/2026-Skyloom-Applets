...
const DATA = {
  en: {
    app: {
      ...
      question: {
        text:
          'A line <span id="highlight-equation" class="orange-bg"><span class=\"math-var\">x</span> + <span class=\"math-var\">y</span> = 2</span> is <span id="highlight-translation" class="purple-bg">translated 2 units to the right and 1 unit upward</span>.<br> <span id="highlight-find" class="purple-bg">What is the equation of the translated line?</span>',
        textPlain:
          "A line x + y = 2 is translated 2 units to the right and 1 unit upward. <br>What is the equation of the translated line?",
      },
      graph: {
  ...
  id: {
    app: {
      ...
      question: {
        text:
          'Garis <span id="highlight-equation" class="orange-bg"><span class=\"math-var\">x</span> + <span class=\"math-var\">y</span> = 2</span> <span id="highlight-translation" class="purple-bg">ditranslasi 2 satuan ke kanan dan 1 satuan ke atas</span>.<br> <span id="highlight-find" class="purple-bg">Berapakah persamaan garis hasil translasi?</span>',
        textPlain:
      ...
      steps: {
        ...
        9: {
          ...
          navTapRearrange: "Ketuk kotak yang disorot untuk menyusun ulang",
