const StepCardsPanel = ({
  ...
  const exploredSet = exploredCardIds || [];
  ...
  return React.createElement(
    ...
    renderCards.map((card) => {
      ...
      const isExplored = exploredSet.indexOf(card.id) !== -1;
      const isInactive =
        activeCardId &&
        activeCardId !== card.id &&
        !isExplored &&
        !card.clickable;
      const contentHighlighted = contentHighlightId === card.id;
      ...
      return React.createElement(
        "div",
        {
          ...
          className:
            ...
            (card.clickable && !isActive ? " is-clickable-ready" : ""),
          ...
          React.createElement(
            "div",
            {
              className:
                ...
                (contentHighlighted ? " is-content-highlight" : ""),
            },
            card.content,
          ),
        ),
