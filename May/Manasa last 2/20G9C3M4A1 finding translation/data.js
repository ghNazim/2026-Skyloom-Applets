...
const DATA = {
  en: {
    app: {
      ...
      rightPanel: {
        instruction: "Simply subtract the pre-image coordinate from the image coordinate.",
        resultHtml:
      ...
      practice: {
        questionText: 'Find the translation for this image <span class="image-text">A\'</span>.',
      ...
      rectangle: {
        questionText: "Use the sliders to move the rectangle to its image position and<br>find the translation.",
      ...
      scenarios: {
        triangle: {
          ...
          imageMark: "\u2019",
          points: {
            P: { pre: [1, 2], image: [6, -1], preSourceId: "tri-pre-p-label", preXSourceId: "tri-pre-p-x", preYSourceId: "tri-pre-p-y", imageSourceId: "tri-img-p-label", imageXSourceId: "tri-img-p-x", imageYSourceId: "tri-img-p-y" },
            Q: { pre: [4, 2], image: [9, -1], preSourceId: "tri-pre-q-label", preXSourceId: "tri-pre-q-x", preYSourceId: "tri-pre-q-y", imageSourceId: "tri-img-q-label", imageXSourceId: "tri-img-q-x", imageYSourceId: "tri-img-q-y" },
            R: { pre: [2, 5], image: [7, 2], preSourceId: "tri-pre-r-label", preXSourceId: "tri-pre-r-x", preYSourceId: "tri-pre-r-y", imageSourceId: "tri-img-r-label", imageXSourceId: "tri-img-r-x", imageYSourceId: "tri-img-r-y" },
          },
          table: {
            x: "x",
            y: "y",
        ...
        line: {
          questionPlain:
            '<span class="overline-text">MN</span> has endpoints <span id="line-pre-m-label">M</span>(<span id="line-pre-m-x">2</span>,<span id="line-pre-m-y">1</span>) and <span id="line-pre-n-label">N</span>(<span id="line-pre-n-x">4</span>,<span id="line-pre-n-y">5</span>). After a translation, the image<br>endpoints are <span id="line-img-m-label">M\u2019</span>(<span id="line-img-m-x">8</span>,<span id="line-img-m-y">3</span>) and <span id="line-img-n-label">N\u2019</span>(<span id="line-img-n-x">10</span>,<span id="line-img-n-y">7</span>). Find the translation.',
          questionHighlighted:
            '<span class="overline-text">MN</span> has endpoints <span class="scenario-highlight scenario-object"><span id="line-pre-m-label">M</span>(<span id="line-pre-m-x">2</span>,<span id="line-pre-m-y">1</span>)</span> and <span class="scenario-highlight scenario-object"><span id="line-pre-n-label">N</span>(<span id="line-pre-n-x">4</span>,<span id="line-pre-n-y">5</span>)</span>. After a translation, the image<br>endpoints are <span class="scenario-highlight scenario-image"><span id="line-img-m-label">M\u2019</span>(<span id="line-img-m-x">8</span>,<span id="line-img-m-y">3</span>)</span> and <span class="scenario-highlight scenario-image"><span id="line-img-n-label">N\u2019</span>(<span id="line-img-n-x">10</span>,<span id="line-img-n-y">7</span>)</span>. Find the translation.',
          options: ["M", "N"],
          id: "line",
          pointLabelPrefix: "Point ",
          imageMark: "\u2019",
          points: {
            M: { pre: [2, 1], image: [8, 3], preSourceId: "line-pre-m-label", preXSourceId: "line-pre-m-x", preYSourceId: "line-pre-m-y", imageSourceId: "line-img-m-label", imageXSourceId: "line-img-m-x", imageYSourceId: "line-img-m-y" },
            N: { pre: [4, 5], image: [10, 7], preSourceId: "line-pre-n-label", preXSourceId: "line-pre-n-x", preYSourceId: "line-pre-n-y", imageSourceId: "line-img-n-label", imageXSourceId: "line-img-n-x", imageYSourceId: "line-img-n-y" },
          },
          table: {
            x: "x",
            y: "y",
      ...
      verification: {
        ruleHtml: 'The translation rule is<br><span class="translation-rule">(+6, +2).</span>',
      ...
      final: {
        heading: "",
        text: "Great job! You can now find the translation (units of<br>movement) when the pre-image coordinates and<br>image coordinates are given.",
  ...
  id: {
    app: {
      ...
      rightPanel: {
        instruction: "Cukup kurangi koordinat pra-bayangan dari koordinat bayangan.",
        resultHtml:
      ...
      practice: {
        questionText: 'Temukan translasi untuk bayangan <span class="image-text">A\'</span> ini.',
      ...
      rectangle: {
        questionText: "Gunakan slider untuk memindahkan persegi panjang ke posisi bayangannya dan<br>temukan translasinya.",
      ...
      scenarioIntro: {
        ...
        choicePrompt: "Pilih salah satu titik untuk<br>menemukan aturan translasi",
      ...
      scenarios: {
        ...
        line: {
          questionPlain:
            '<span class="overline-text">MN</span> memiliki titik ujung <span id="line-pre-m-label">M</span>(<span id="line-pre-m-x">2</span>,<span id="line-pre-m-y">1</span>) dan <span id="line-pre-n-label">N</span>(<span id="line-pre-n-x">4</span>,<span id="line-pre-n-y">5</span>). Setelah translasi, titik ujung<br>bayangannya adalah <span id="line-img-m-label">M\u2019</span>(<span id="line-img-m-x">8</span>,<span id="line-img-m-y">3</span>) dan <span id="line-img-n-label">N\u2019</span>(<span id="line-img-n-x">10</span>,<span id="line-img-n-y">7</span>). Temukan translasinya.',
          questionHighlighted:
            '<span class="overline-text">MN</span> memiliki titik ujung <span class="scenario-highlight scenario-object"><span id="line-pre-m-label">M</span>(<span id="line-pre-m-x">2</span>,<span id="line-pre-m-y">1</span>)</span> dan <span class="scenario-highlight scenario-object"><span id="line-pre-n-label">N</span>(<span id="line-pre-n-x">4</span>,<span id="line-pre-n-y">5</span>)</span>. Setelah translasi, titik ujung<br>bayangannya adalah <span class="scenario-highlight scenario-image"><span id="line-img-m-label">M\u2019</span>(<span id="line-img-m-x">8</span>,<span id="line-img-m-y">3</span>)</span> dan <span class="scenario-highlight scenario-image"><span id="line-img-n-label">N\u2019</span>(<span id="line-img-n-x">10</span>,<span id="line-img-n-y">7</span>)</span>. Temukan translasinya.',
          options: ["M", "N"],
          id: "line",
          pointLabelPrefix: "Titik ",
          imageMark: "\u2019",
      ...
      verification: {
        ruleHtml: 'Aturan translasinya adalah<br><span class="translation-rule">(+6, +2).</span>',
      ...
      final: {
        heading: "",
        text: "Bagus! Sekarang kamu dapat menemukan translasi (satuan<br>perpindahan) ketika koordinat pra-bayangan dan<br>koordinat bayangan diberikan.",
