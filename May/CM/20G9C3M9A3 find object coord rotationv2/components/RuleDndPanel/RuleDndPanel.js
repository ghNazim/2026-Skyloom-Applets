const RuleDndPanel = ({
    ...
    return React.createElement(
      ...
      placed
        ? React.createElement(
            ...
            renderMathVars(items[placed].label),
          )
        : null,
      isWrongTarget
        ? React.createElement(
            ...
            renderMathVars(items[wrongItemId].label),
          )
        : null,
    );
  };
  ...
  const renderGhost = () => {
    ...
    return React.createElement(
      ...
      renderMathVars(items[draggedItem].label),
    );
  };
      ...
      : React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              renderMathVars(panel.rulePrefix),
            ),
            ...
            React.createElement(
              "span",
              { className: "rule-dnd-math" },
              renderMathVars(panel.ruleSuffix),
            ),
          ),
          !bothCorrect
            ? React.createElement(
