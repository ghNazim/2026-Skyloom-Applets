...
const MainCanvas = (props) => {
  ...
  const renderStep1AnimatedRow = () => {
    const arrowLabel = formatMovementLabel(
      APP_DATA.steps[1].unitsRight,
      step1Snapped,
    );
    return React.createElement(
      "div",
      ...
      if (step1Snapped !== 0) {
        rows.push(
          React.createElement(
            ...
            renderArrowBlock(
              formatMovementLabel(APP_DATA.steps[1].unitsRight, step1Snapped),
            ),
        ...
        rows.push(
          step2Phase === "building"
            ...
            : React.createElement(
                ...
                renderCoordPair({ x: "3", y: "3" }),
                renderArrowBlock(formatMovementLabel(s2.unitsLeft, step2Snapped)),
    ...
    if (step === 3 && (step3Phase === "building" || step3Phase === "done")) {
      ...
      return step3Phase === "building"
        ...
        : React.createElement(
            ...
            renderArrowBlock(formatMovementLabel(s3.unitsUp, step3Snapped)),
      ...
      if (step3Snapped !== 0) {
        rows.push(
          React.createElement(
            ...
            renderCoordPairY("3", "3"),
            renderArrowBlock(
              formatMovementLabel(APP_DATA.steps[3].unitsUp, step3Snapped),
            ),
            renderCoordExprY(BASE_X, BASE_Y, step3Snapped, "expression"),
          ),
        );
        ...
        rows.push(
          step4Phase === "building"
            ...
            : React.createElement(
                ...
                renderCoordPairY("3", "3"),
                renderArrowBlock(formatMovementLabel(s4.unitsDown, step4Snapped)),
