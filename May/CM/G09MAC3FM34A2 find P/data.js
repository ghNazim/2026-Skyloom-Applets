  ...
  en: {
    app: {
      ...
      question: {
        ...
        solve:
          "Let’s find P(<i class='math-var'>x</i>, <i class='math-var'>y</i>) so that two triangles are congruent.",
      },
      graph: {
        labels: {
          A: "A(4, 1)",
      ...
      steps: {
        ...
        7: {
          ...
          belowText:
            "First let's consider QR↔BC, let's transform △ABC so that BC overlaps QR.",
          orLabel: "OR",
        },
        8: {
          navText: " ",
        ...
        9: {
          ...
          belowText: "Fix orientation first so that BC aligns with QR.",
          rotateButton: "Rotate",
          rotateTitle:
            "Rotate △ABC about the origin until orientation of side BC aligns with side QR.",
        },
        10: {
        ...
        12: {
          navDone: "Tap » to find another possible position for vertex P.",
          belowText:
            "Now, let's consider QR↔CB and transform △ABC such that CB coincides with QR.\n\nThen P sits in a different place, maintaining congruency.",
        },
        13: {
          navDone: "Tap » to transform △ABC into △PQR.",
          belowText:
            "Let's  transform △ABC again such that its sides coincides with the new side lengths.",
        },
        14: {
          navIntro: "Tap 'Rotate'.",
          navSlider: "Use slider to rotate the triangle",
          navDone:
            "Tap » to align the rotated triangle so that CB coincides with QR.",
          belowText: "Fix orientation first so that CB aligns with QR.",
          rotateButton: "Rotate",
          rotateTitle:
            "Rotate △ABC about the origin until orientation of side CB aligns with side QR.",
        },
        15: {
          navIntro: "Tap ‘Translate’.",
          navControls: "Tap arrows to move the triangle.",
          ...
          belowText:
            "Rotation aligned the orientation.\nNow, translate the triangle.",
          translateButton: "Translate",
          translateTitle: "Translate △ABC so that CB ↔ QR",
        },
        16: {
          navIntro: "Tap ‘Reflect’.",
  ...
  id: {
    app: {
      ...
      question: {
        ...
        solve:
          "Mari cari P(<i class='math-var'>x</i>, <i class='math-var'>y</i>) sehingga kedua segitiga kongruen.",
      },
      graph: {
        labels: {
          A: "A(4, 1)",
      ...
      steps: {
        ...
        7: {
          ...
          belowText:
            "Pertama, mari pertimbangkan QR↔BC, lalu transformasikan △ABC sehingga BC berimpit dengan QR.",
          orLabel: "OR",
        },
        8: {
          navText: " ",
        ...
        9: {
          ...
          belowText:
            "Perbaiki orientasi terlebih dahulu agar BC sejajar dengan QR.",
          rotateButton: "Rotate",
          rotateTitle:
            "Putar △ABC terhadap titik asal hingga orientasi sisi BC sejajar dengan sisi QR.",
        },
        10: {
        ...
        12: {
          navDone:
            "Ketuk » untuk mencari kemungkinan posisi lain untuk titik P.",
          belowText:
            "Sekarang, mari pertimbangkan QR↔CB dan transformasikan △ABC sehingga CB berimpit dengan QR.\n\nMaka P berada di tempat yang berbeda, tetap mempertahankan kekongruenan.",
        },
        13: {
          navDone: "Ketuk » untuk mentransformasikan △ABC menjadi △PQR.",
          belowText:
            "Mari transformasikan △ABC lagi sehingga sisi-sisinya berimpit dengan panjang sisi yang baru.",
        },
        14: {
          navIntro: "Ketuk 'Rotate'.",
          navSlider: "Gunakan penggeser untuk memutar segitiga",
          navDone:
            "Ketuk » untuk menggeser segitiga yang sudah diputar agar CB berimpit dengan QR.",
          belowText:
            "Perbaiki orientasi terlebih dahulu agar CB sejajar dengan QR.",
          rotateButton: "Rotate",
          rotateTitle:
            "Putar △ABC terhadap titik asal hingga orientasi sisi CB sejajar dengan sisi QR.",
        },
        15: {
          navIntro: "Ketuk ‘Translate’.",
          navControls: "Ketuk panah untuk menggerakkan segitiga.",
          ...
          belowText:
            "Rotasi telah menyelaraskan orientasi.\nSekarang, translasikan segitiga.",
          translateButton: "Translate",
          translateTitle: "Translasi △ABC sehingga CB ↔ QR",
        },
        16: {
          navIntro: "Ketuk ‘Reflect’.",
