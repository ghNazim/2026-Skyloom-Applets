const DilationGraph = (props) => {
  ...
  const renderAxes = () => {
    ...
    return React.createElement(
      React.Fragment,
      null,
      axisLine(right.x - markerOffset, o.y, "axis-pos-x"),
      axisLine(left.x + markerOffset, o.y, "axis-neg-x"),
      axisLine(o.x, top.y + markerOffset, "axis-pos-y"),
      axisLine(o.x, bottom.y - markerOffset, "axis-neg-y"),
      React.createElement(
        "text",
        {
          x: right.x + 10,
  ...
  const renderPolygon = (poly) => {
    ...
    const polyOpacity = poly.dimmed ? dimOpacity * 0.35 : dimOpacity;
    ...
    showSlider
      ? React.createElement(
          ...
          React.createElement(
            ...
            renderStyledVariableText(APP_DATA.slider.label),
          ),
          React.createElement(
            "div",
            {
      ...
      : null,
    displayFeedbackHtml || feedbackPromptHtml
      ? React.createElement(
          "div",
          { className: "feedback-stack feedback-stack-top-left" },
          displayFeedbackHtml
            ? React.createElement("div", {
                className:
                  "feedback-box" +
          ...
          feedbackPromptHtml
            ? React.createElement("div", {
                className: "feedback-question-text",
                dangerouslySetInnerHTML: { __html: feedbackPromptHtml },
              })
            : null,
        )
      : null,
