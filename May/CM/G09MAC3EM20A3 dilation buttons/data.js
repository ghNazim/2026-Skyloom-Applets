  ...
  en: {
    app: {
      ...
      finish: {
        heading: "Properties of Dilation",
        text:
          "<left>When a figure is dilated:<br>\u25cf The shape of the image is preserved.<br>\u25cf The size of the image changes.<br>\u25cf The image does not rotate unless the scale factor is negative.<br>\u25cf The position of the image changes.<br><br>Tap \u2018Start Over\u2019 to restart.</left>",
      ...
      feedback: {
        ...
        orientationInitial:
          "<b>Scale factor &gt; 0</b><br>- no change in orientation",
        orientationQuestion:
          "<y>What if the scale factor (k) &lt; 0?</y>",
        orientationFinal:
  ...
  id: {
    app: {
      ...
      feedback: {
        ...
        orientationInitial:
          "<b>Faktor skala &gt; 0</b><br>- tidak ada perubahan orientasi",
        orientationQuestion:
          "<y>Bagaimana jika faktor skala (k) &lt; 0?</y>",
        orientationFinal:
