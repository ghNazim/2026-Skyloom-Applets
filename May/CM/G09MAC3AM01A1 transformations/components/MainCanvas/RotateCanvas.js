const RotateCanvas = function (props) {
  ...
  var hasRotateStartedState = useState(false);
  var hasRotateStarted = hasRotateStartedState[0];
  var setHasRotateStarted = hasRotateStartedState[1];
  ...
  useEffect(
    ...
    [showBlueBox, showRevealBtn, summaryTextComplete, onNudgeTarget]
  );
  ...
  var handleBlueBoxClick = useCallback(
    ...
    [onNudgeDismiss, onUpdateQuestion, ROTATE.questionTranslation, onTextLayoverActive]
  );
  ...
  var handleTextLayoverClose = useCallback(
    ...
    [startDefinitionTyping, onRotateFlowComplete, onTextLayoverActive]
  );
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          definitionTyped
            ...
            : React.createElement(AnimatedSummaryElement, {
    ...
    React.createElement(
      ...
      rotatePhase === "rotate" &&
        ...
        React.createElement(
          "g",
          {
            className: "rotate-nudge-orbit",
            style: {
              transformOrigin: centerC.x + "px " + centerC.y + "px",
            },
          },
          React.createElement("image", {
            href: "assets/tap.png",
