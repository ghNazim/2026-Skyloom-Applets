    ...
    app: {
      ...
      steps: {
        ...
        3: {
          ...
          definitionTyping:
            "A transformation in which every point of a figure changes its POSITION by the\n SAME DISTANCE in the \nSAME DIRECTION.",
          textLayover: {
            body:
              "<y>Translation is a transformation</y> when point(s)<br>are moved from one position to another<br><y>to a particular distance in a particular direction</y>.<br><br><bl>Translation causes no change in orientation, shape or size</bl><br>of a collection of points.",
      ...
      mirror: {
        ...
        imageAppearQuestion:"Move the mirror so the reflected image reaches the target",
        ...
        revealSummary: {
          text:
            "Every point on the figure<br>changed its position<br>causing change in orientation",
        },
        fullSummary: {
          line1: "Flipping the figure caused",
          lines: [
  ...
  id: {
    app: {
      ...
      mirror: {
        ...
        imageAppearQuestion:"Gerakkan cermin sehingga bayangan yang dipantulkan mencapai target",
