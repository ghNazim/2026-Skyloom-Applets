...
const SHARED_ID = {
  ...
  start: {
    ...
    text: "Mari kita pelajari cara mencari persamaan<br>bayangan garis yang direfleksikan ketika dua titik pada garis diberikan,<br>menggunakan rumus persamaan garis saat dua titik diketahui.<br>Klik <y>MULAI</y> untuk memulai!",
    buttonText: "MULAI",
  },
  complete: {
    heading: "Aktivitas Selesai!",
    text: "Bagus!<br>Kalian sekarang dapat mencari persamaan garis refleksi<br>menggunakan rumus persamaan garis saat dua titik diketahui.<br><br>Substitusikan koordinat titik-titik pada garis ke dalam rumus dua titik dan<br> sederhanakan persamaan tersebut.<br><br>Klik <y>MULAI LAGI</y> untuk mengulang aktivitas ini!",
  ...
  step2Shared: {
    ...
    coordTextB: "B\u2032(",
    coordAnd: " dan ",
    formulaTitle: "Rumus persamaan garis saat dua titik diketahui:",
    rightText:
    ...
    rightTextAfter: "Sekarang, sederhanakan persamaan ini<br>dalam bentuk",
  ...
  step3Shared: {
    ...
    feedbackWrong: "Oops! Tidak benar.<br>Sederhanakan dan coba lagi!",
  },
  nav: {
  ...
  feedback: {
    coordinateWrong: "Oops!<br>Periksa aturan refleksi dan coba lagi.",
  },
};
...
const PROBLEMS_EN = [
  ...
  },
  {
    ...
    step3: {
      options: ["x \u2212 y = 5", "x + y = 5", "x \u2212 y = \u22125"],
      correctIndex: 0,
      feedbackCorrect:
        "That\u2019s correct.<br>x \u2212 y = 5 is the equation<br>of the reflection of line AB.",
    },
    step4: {
...
const PROBLEMS_ID = [
  ...
  },
  {
    ...
    step3: {
      ...
      correctIndex: 0,
      feedbackCorrect:
        "Benar.<br>x \u2212 y = 5 adalah persamaan<br>refleksi garis AB.",
    },
    step4: {
