...
const DATA = {
  ...
  id: {
    app: {
      start: {
        heading: "Kesebangunan S.Sd.S.",
        text:
          "Mari pelajari apakah dua pasang sisi bersesuaian<br>" +
          "yang proporsional membuat dua segitiga sebangun.",
        buttonText: "Pelajari",
      },
      steps: {
        1: {
          questionText: "Buat segitigamu sendiri.",
          navText: "Gerakkan titik sudut untuk mengubah panjang sisi segitiga.",
          navInteracted: "Ketuk » setelah kamu membuat segitiga.",
        },
        2: {
          questionText: "Ayo bangun segitiga lain dengan dua pasang sisi berpadanan yang proporsional.",
          navText: "Ketuk tombol untuk memilih rasio sisi-sisi yang berpadanan.",
          navAfterAnimation: "Ketuk » untuk membuat segitiga kuning.",
          proportionalText: "Dua pasang sisi yang berpadanan proporsional",
        },
        3: {
          questionText: "Gabungkan panjang sisi untuk membuat segitiga baru.",
          navText:
        ...
        4: {
          ...
          navDone: "Ketuk tombol untuk memeriksa kesebangunannya.",
        ...
        6: {
          questionText:
            "Dua pasang sisi berpadanan yang proporsional belum cukup untuk membuat dua segitiga sebangun.",
        ...
        7: {
          ...
          navCheck: "Ketuk tombol untuk memeriksa kesebangunannya.",
        ...
        8: {
          questionText: "Ayo lihat apa nama aturan ini.",
          navText: "Ketuk tombol untuk mengungkapkan namanya.",
          panelText:
            "Dua pasang sisi berpadanan yang proporsional dan sudut apit yang sama membuat dua segitiga sebangun.",
          nameButtonText: "Nama",
          sasName: "Kesebangunan S.Sd.S.",
          questionRevealed: "Ini disebut kesebangunan S.Sd.S.",
