...
const DATA = {
  en: {
    app: {
      ...
      step4Substeps: [
        {
          btn: "Look at the parallel lines and the transversal, shout out what do you say about the two angles measures.",
          img: "assets/6in.svg",
          textAfter:
  ...
  id: {
    app: {
      steps: {
        1: {
          questionText:
            "Baca pertanyaan dan tentukan yang ‘diketahui’ dan ‘yang dicari’",
          navText: "Ketuk » untuk menentukan informasi yang ‘diketahui’",
        },
        2: {
          navText: "Ketuk » untuk menentukan informasi yang ‘diketahui’",
        ...
        3: {
          ...
          img: "assets/5in_id.svg",
          imgAfter: "assets/5end_id.svg",
          navAfter:
        ...
        5: {
          questionText: "Mencari tinggi tiang.",
          navText: "Ketuk tombol \u2018?\u2019 untuk mengungkap jawabannya.",
          navAfter: "Ketuk \u00BB untuk merangkum",
        },
        6: {
          questionText: "Mencari tinggi tiang.",
      ...
      step4Substeps: [
        {
          btn: "Perhatikan garis-garis sejajar dan garis transversal, apa yang dapat kamu simpulkan tentang besar kedua sudut tersebut?",
          img: "assets/6in_id.svg",
          textAfter:
            'Besar kedua sudut sama.<br><span class="text-after-sub">(Sudut-sudut sehadap)</span>',
          imgAfter: "assets/6end_id.svg",
          navAfter: "Ketuk \u00BB untuk melihat bentuk objek dan bayangannya.",
        },
        {
          btn: "Sebutkan bentuk yang terbentuk oleh objek dan bayangannya?",
          textAfter: "Segitiga siku-siku",
          img: "assets/7in_id.svg",
          imgAfter: "assets/7end_id.svg",
          navAfter:
            "Ketuk \u00BB untuk melihat hubungan antara kedua segitiga.",
        },
        {
          btn: "Kedua segitiga memiliki dua sudut yang bersesuaian sama besar. Sebutkan nama segitiga seperti ini?",
          textAfter: "Segitiga Sebangun",
          img: "assets/8in_id.svg",
          imgAfter: "assets/8end_id.svg",
          navAfter:
            "Ketuk \u00BB untuk melihat bagaimana sisi-sisi berhubungan pada segitiga sebangun.",
        },
        {
          btn: "Bagaimana hubungan sisi-sisi yang bersesuaian pada segitiga sebangun?",
          textAfter: "Sisi-sisi yang bersesuaian berbanding senilai",
          img: "assets/9in_id.svg",
          imgAfter: "assets/9end_id.svg",
