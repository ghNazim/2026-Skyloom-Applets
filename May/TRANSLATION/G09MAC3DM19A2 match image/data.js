      ...
      panels: {
        ...
        rotateAgainDrag: {
          lines: [
            ...
            [
              { text: "Seret tombol untuk memutar objek 90\u00b0 searah jarum jam terhadap titik asal." },
            ],
          ],
        },
        orientationDone2: {
        ...
        completed: {
          ...
          lines: [
            [{ text: "Bagus! Sekarang kamu dapat menggunakan rangkaian <br>transformasi untuk mencocokkan objek dengan bayangan." }],
