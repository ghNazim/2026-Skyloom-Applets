...
const DATA = {
        ...
        2: {
          steps: {
            1: {
              ...
              spinnerBInfo:
                "<sb>Spinner A</sb> has the numbers<br> 1, 2, 3, 4.",
              spinnerALabel: "Coin",
        ...
        3: {
          steps: {
            1: {
              ...
              spinnerAInfo: "<sa>Coin</sa> has the outcomes<br> H and T.",
              spinnerBInfo:
                "<sb>Die</sb> has the numbers<br> 1, 2, 3, 4, 5, 6.",
              spinnerALabel: "Coin",
              spinnerBLabel: "Die",
            },
            2: {
  ...
  id: {
    app: {
      start: {
        heading: "Metode Mendaftar",
        text:
          "Kamu sudah belajar metode mendaftar untuk <y>menemukan ruang sampel</y>.<br>" +
          "Sekarang saatnya berlatih!<br>" +
          "Kamu akan mengerjakan <y>tiga eksperimen</y>.<br>" +
          "Tugasmu: <y>temukan ruang sampel</y> dan<br>" +
          "<y>hasilnya</y> untuk setiap kejadian!<br>" +
      ...
      complete: {
        ...
        text:
          "Kamu telah berlatih <y>metode mendaftar</y> pada<br>" +
          "tiga eksperimen yang berbeda!<br><br>" +
          "Ingat:<br>" +
          "<y>Langkah 1 &ndash; Tentukan hasil dari setiap objek</y><br>" +
      ...
      experiments: {
        1: {
          steps: {
            1: {
              questionText: "EKSPERIMEN 1: Dua Pemutar Berbeda",
              navText: "Ketuk &raquo; untuk langkah 1",
              title: "Kamu memutar dua pemutar secara bersamaan.",
              footerText:
                "Gunakan metode mendaftar untuk menemukan semua hasil yang mungkin.",
              spinnerAInfo: "<sa>Pemutar A</sa> memiliki angka<br> 1, 2, 3.",
              spinnerBInfo: "<sb>Pemutar B</sb> memiliki angka<br> 1, 2.",
              spinnerALabel: "Pemutar A",
              spinnerBLabel: "Pemutar B",
            },
            2: {
              questionText: "EKSPERIMEN 1: Dua Pemutar Berbeda",
              ...
              title:
                "Langkah 1: Tentukan hasil yang mungkin dari setiap objek.",
              spinnerALabel: "Pemutar A",
              spinnerBLabel: "Pemutar B",
            },
            3: {
            ...
            4: {
              questionText: "EKSPERIMEN 1: Dua Pemutar Berbeda",
              navText:
                "Untuk mulai memasangkan, ketuk hasil pertama Pemutar A.",
              navSecond:
                "Untuk lanjut memasangkan, ketuk hasil kedua Pemutar A.",
              navThird:
                "Untuk lanjut memasangkan, ketuk hasil ketiga Pemutar A.",
              navDone:
            ...
            5: {
              questionText: "EKSPERIMEN 1: Dua Pemutar Berbeda",
              navText: "Ketuk hasilnya lalu kirim.",
              navReset: "Ketuk &lsquo;Reset&rsquo; untuk mencoba lagi.",
              navDone:
                "Ketuk &raquo; untuk melihat kejadian lain pada eksperimen ini.",
              eventTitleHtml:
                "<y>Kejadian (E)</y> : Mendapat bilangan genap pada pemutar pertama.",
              sampleSpaceLabel: "Ruang sampel (S)",
              nELabel: "n(E)",
              submitText: "Kirim",
              resetText: "Reset",
              correctAnswers: [2, 3],
              feedbackCorrect: "Benar! Kamu telah menemukan semua hasilnya!",
              feedbackWrong:
                "Bilangan genap pada pemutar pertama berarti angka pertama pada pasangan harus genap. Coba lagi!",
            },
            6: {
              questionText: "EKSPERIMEN 1: Dua Pemutar Berbeda",
              navText: "Ketuk hasilnya lalu kirim.",
              ...
              eventTitleHtml:
                "<y>Kejadian (E)</y> : Mendapat angka 2 pada setidaknya satu pemutar.",
              sampleSpaceLabel: "Ruang sampel (S)",
              nELabel: "n(E)",
              submitText: "Kirim",
              resetText: "Reset",
              ...
              feedbackCorrect: "Benar. Kamu telah menemukan semua hasilnya.",
              feedbackWrong:
                'Periksa kedua pemutar. Suatu pasangan memiliki "setidaknya satu 2" jika angka 2 ada pada pemutar pertama, pemutar kedua, atau keduanya.',
            },
          },
        },
        2: {
          steps: {
            1: {
              questionText: "EKSPERIMEN 2: Koin dan Pemutar",
              navText: "Ketuk &raquo; untuk langkah 1",
              title: "Kamu melempar koin dan memutar pemutar secara bersamaan.",
              footerText:
                "Gunakan metode mendaftar untuk menemukan semua hasil yang mungkin.",
              spinnerAInfo:
                "<sa>Koin</sa> memiliki hasil<br> Angka (A) dan Gambar (G).",
              spinnerBInfo: "<sb>Pemutar A</sb> memiliki angka<br> 1, 2, 3, 4.",
              spinnerALabel: "Koin",
              spinnerBLabel: "Pemutar A",
            },
            2: {
              questionText: "EKSPERIMEN 2: Koin dan Pemutar",
              navText: "Seret tombol ke tempat yang benar.",
