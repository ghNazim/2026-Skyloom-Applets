    ...
    app: {
      steps: {
        1: {
          ...
          navText: "Tap \u00BB to find \u2018" + HEIGHT_VAR.en + "\u2019.",
        },
        2: {
        ...
        5: {
          ...
          navAfterConclude:
            "Tap \u00BB to find " + HEIGHT_VAR.en + " using corresponding sides.",
        ...
        6: {
          questionText:
            "Let\u2019s find " + HEIGHT_VAR.en + " using similar triangles.",
          navText: "",
    ...
    app: {
      steps: {
        1: {
          ...
          navText: "Ketuk » untuk mencari \u2018" + HEIGHT_VAR.id + "\u2019.",
        },
        2: {
        ...
        5: {
          ...
          navAfterConclude:
            "Ketuk » untuk mencari " +
            HEIGHT_VAR.id +
            " menggunakan sisi yang bersesuaian.",
        ...
        6: {
          questionText:
            "Mari cari " + HEIGHT_VAR.id + " menggunakan segitiga sebangun.",
          navText: "",
          navCompute: "Ketuk tombol untuk menghitung ekspresi.",
          questionComplete: "Tinggi pohon = 15 cm",
          navComplete:
      ...
      labels: {
        heightTree: HEIGHT_VAR.id,
        heightMan: "5 cm",
        distanceTotal: "24 cm",
        distanceAB: "8 cm",
        heightTreeResult: "15 cm",
      },
    },
  },
};
...
const heightVar = HEIGHT_VAR[current_language];
