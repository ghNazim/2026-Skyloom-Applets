...
const MainCanvas = (props) => {
    ...
    const doStep = () => {
      ...
      if (subStep === 0) {
        ...
        setFlyingClones((prev) => [...prev, {
          id: cloneId, text: formatDecimalDisplay(yellowLine.displayLength),
        ...
        setFlyingClones((prev) => [...prev, {
          id: cloneId, text: formatDecimalDisplay(sideLength),
          from: fromPt, to: toPt,
    ...
    return React.createElement(
      ...
      sides.map((side) => {
        ...
        return React.createElement(
          ...
          formatDecimalDisplay(fmtLen(side.len)) + " cm"
        );
      })
    );
  };
      ...
      yellowLines.map((line) => {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            formatDecimalDisplay(line.displayLength) + " cm"
          )
        );
      })
    );
  ...
  const renderRatioBox = () => {
    ...
    return React.createElement(
      ...
      }, "= " + formatDecimalDisplay(selectedRatio))
    );
  };
  ...
  const renderOverlapYellow = () => {
    ...
    const displayLen = (key, yellowVal) => {
      ...
      const scaled = step === 5 ? blended * step5YellowScale : blended;
      return fmtLen(scaled);
    };
    ...
    return React.createElement(
      ...
      yellowSides.map((side) => {
        ...
        return React.createElement(
          ...
          formatDecimalDisplay(displayLen(side.key, side.yellowLen)) + " cm",
        );
      }),
    );
  };
