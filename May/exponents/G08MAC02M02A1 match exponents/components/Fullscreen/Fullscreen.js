...
const Fullscreen = ({ text, buttonText, onButtonClick, heading, left = false, isFinal = false, imageSrc, showNudge = false }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "fullscreen-button-area" },
      React.createElement(Button, {
        text: buttonText,
        onClick: onButtonClick,
      }),
      showNudge && React.createElement(Nudge)
    )
  );
};
