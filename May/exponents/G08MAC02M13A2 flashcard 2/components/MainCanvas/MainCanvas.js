const MainCanvas = function (props) {
  ...
  var _showOverlay = useState(false);
  var showOverlay = _showOverlay[0];
  var setShowOverlay = _showOverlay[1];
  ...
  var handleOptionSelect = function (option) {
    ...
    if (isCorrect) {
      ...
      onUpdateNav(q.correctFeedback, "correct");
  ...
  return React.createElement(
    ...
    React.createElement(SolutionOverlay, {
      visible: showOverlay,
