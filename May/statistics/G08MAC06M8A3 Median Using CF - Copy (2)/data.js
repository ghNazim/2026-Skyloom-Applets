const DATA = {
  en: {
    app: {
      ...
      feedback: {
        orderReminder: "Remember, to find the median, the data should always be ordered from smallest to largest.<br>In table too either start with smallest or the largest data point.",
      ...
      final: {
        heading: "Great work!",
        text: "The cumulative frequency table is ready.<br><br>Next, you can use the middle position to find the median.",
  ...
  id: {
    app: {
      ...
      feedback: {
        orderReminder: "Ingat, untuk mencari median, data harus selalu diurutkan dari yang terkecil ke yang terbesar.<br>Di tabel juga, mulailah dari titik data terkecil atau terbesar.",
      ...
      final: {
        heading: "Kerja bagus!",
        text: "Tabel frekuensi kumulatif sudah siap.<br><br>Selanjutnya, kamu dapat menggunakan posisi tengah untuk mencari median.",
        buttonText: "Ulangi",
      },
    },
  },
