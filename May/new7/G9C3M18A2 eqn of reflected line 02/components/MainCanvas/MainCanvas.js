...
function fmtHtml(html) {
  return formatMathVariablesInHtml(html);
}

function renderAxByCFormula(className, tag) {
  return ce(
    tag || "span",
    { className: className },
    "a",
    ce("span", { className: "math-var" }, "x"),
    " + b",
    ce("span", { className: "math-var" }, "y"),
    " = c",
  );
}
...
var MainCanvas = function (props) {
      ...
      if (props.showCoordFeedback) {
        feedbackEl = ce("div", {
          ...
          dangerouslySetInnerHTML: {
            __html: fmtHtml(APP_DATA.feedback.coordinateWrong),
          },
        });
      } else {
        ...
        ce(
          ...
          ce(
            ...
            ce(
              ...
              ce("div", {
                className: "row-title",
                dangerouslySetInnerHTML: { __html: fmtHtml(rowTitle) },
              }),
              showHintLabels
                ? ce(
                    "div",
  ...
  function renderStep2() {
    ...
    var rightNum;
    if (ySubbed) {
      if (S.yNumSimplifyTo && yDenSimp) {
        rightNum = ce(
          "div",
          { className: "tpf-num" },
          mvar(S.yNumSimplifyTo),
        );
      } else {
        rightNum = ce(
          "div",
    ...
    if (rightChanged) {
      rightContent = ce(
        ...
        ce("p", {
          ...
          dangerouslySetInnerHTML: { __html: fmtHtml(APP_DATA.step2.rightTextAfter) },
        }),
        renderAxByCFormula("step2-right-formula", "p"),
        ce(
          "p",
          { className: "step2-right-text" },
      ...
      rightContent = ce(
        ...
        ce("p", {
          className: "step2-right-text",
          dangerouslySetInnerHTML: { __html: fmtHtml(APP_DATA.step2.rightText) },
        }),
        ce(
          "button",
          {
      ...
      ce(
        ...
        ce(
          ...
          ce("div", {
            ...
            dangerouslySetInnerHTML: {
              __html: fmtHtml(APP_DATA.step2.headingLeft),
            },
          }),
          ce(
            "div",
            ...
            ce("div", {
              className:
                ...
                (props.step2LeftVisible ? "" : " hidden-content"),
              dangerouslySetInnerHTML: {
                __html: fmtHtml(APP_DATA.step2.formulaTitle),
              },
            }),
            ce(
              "div",
  ...
  function renderStep3() {
    ...
    function renderNumerator(variable, op, val) {
      return ce(
        "div",
        { className: "tpf-num" },
        mvar(variable),
        op ? ce("span", { className: "tpf-op" }, " " + op + " ") : null,
        op ? val : null,
      );
    }
    ...
    var formulaEl = ce(
      ...
      ce(
        "div",
        { className: "tpf-fraction" },
        renderNumerator("x", f.leftNumOp, f.leftNumVal),
        ce("div", { className: "tpf-bar" }),
      ...
      ce(
        "div",
        { className: "tpf-fraction" },
        renderNumerator("y", f.rightNumOp, f.rightNumVal),
        ce("div", { className: "tpf-bar" }),
    ...
    if (props.simplifyStatus === "correct") {
      feedbackEl = ce("div", {
        ...
        dangerouslySetInnerHTML: {
          __html: fmtHtml(APP_DATA.step3.feedbackCorrect),
        },
      });
      ...
      feedbackEl = ce("div", {
        ...
        dangerouslySetInnerHTML: {
          __html: fmtHtml(APP_DATA.step3.feedbackWrong),
        },
      });
    }
    ...
    return ce(
      ...
      ce(
        ...
        ce("div", {
          ...
          dangerouslySetInnerHTML: {
            __html: fmtHtml(APP_DATA.step3.headingLeft),
          },
        }),
        ce(
          "div",
          ...
          ce("div", {
            ...
            dangerouslySetInnerHTML: {
              __html: fmtHtml(APP_DATA.step3.formulaTitle),
            },
          }),
          ...
          ce(
            ...
            renderAxByCFormula("step3-simplify-formula"),
          ),
        ),
      ),
      ce(
        ...
        ce("div", {
          ...
          dangerouslySetInnerHTML: { __html: fmtHtml(APP_DATA.step3.mcqTitle) },
        }),
        ce(
          "div",
  ...
  function renderStep4() {
    ...
    var problemGraphConfig =
      APP_DATA.graphConfigKey &&
      typeof REFLECTION_PROBLEM_GRAPH_CONFIGS !== "undefined"
        ? REFLECTION_PROBLEM_GRAPH_CONFIGS[APP_DATA.graphConfigKey]
        : null;
    var points = [];
    ...
    if (phase >= 7) {
      ...
      if (APP_DATA.step4.equationLabelOffset != null) {
        imageLine.labelOffset = APP_DATA.step4.equationLabelOffset;
      }
      if (APP_DATA.step4.equationLabelAngleOffset != null) {
        imageLine.labelAngleOffset = APP_DATA.step4.equationLabelAngleOffset;
      }
      if (APP_DATA.step4.equationLabelAtThroughMidpoint != null) {
        imageLine.labelAtThroughMidpoint =
          APP_DATA.step4.equationLabelAtThroughMidpoint;
      }
      extendedLines.push(imageLine);
    }
    ...
    if (phase >= 4 && APP_DATA.step4.reflectionAxisLine) {
      reflectionAxisLine = Object.assign({}, APP_DATA.step4.reflectionAxisLine, {
        ...
        noArrows: true,
        showLabelAfterGrow: true,
        labelColor: REFLECTION_GRAPH_ORANGE,
      });
    }
    ...
    return ce(
      ...
      ce(
        ...
        ce("div", {
          className: "step2-heading-bar",
          dangerouslySetInnerHTML: {
            __html: fmtHtml(APP_DATA.step4.headingLeft),
          },
        }),
        ce(
          "div",
          ...
          ce(TranslationGraphPanel, {
            graphConfig:
              problemGraphConfig ||
              APP_DATA.graphConfig ||
              REFLECTION_LINE_GRAPH_CONFIG,
            points: points,
      ...
      ce(
        ...
        ce("div", {
          ...
          dangerouslySetInnerHTML: { __html: fmtHtml(APP_DATA.step4.rightText) },
        }),
      ),
    );
  }
  ...
  function renderFlyClones() {
    ...
    return flyClones.map(function (clone) {
      return ce("div", {
        ...
        dangerouslySetInnerHTML: { __html: fmtHtml(clone.html) },
      });
    });
  }
