        ...
        challenges: [
          {
            ...
            line: { axis: "y", value: -3 },
            answer: { x: 2, y: -1 },
            mcqOptionOrder: [0, 1, 2, 3],
            draggableOrder: ["x", "y", "param"],
          },
          {
            point: { x: -4, y: 2 },
            line: { axis: "x", value: -1 },
            answer: { x: 2, y: 2 },
            mcqOptionOrder: [2, 0, 3, 1],
            draggableOrder: ["param", "x", "y"],
          },
          {
            point: { x: 3, y: 5 },
            line: { axis: "y", value: 4 },
            answer: { x: 3, y: 3 },
            mcqOptionOrder: [1, 3, 0, 2],
            draggableOrder: ["y", "param", "x"],
          },
          {
            point: { x: -2, y: -6 },
            line: { axis: "x", value: 2 },
            answer: { x: 6, y: -6 },
            mcqOptionOrder: [3, 2, 1, 0],
            draggableOrder: ["x", "param", "y"],
          },
        ],
