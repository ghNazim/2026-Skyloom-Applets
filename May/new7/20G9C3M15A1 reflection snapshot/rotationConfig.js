    ...
    finalGuides: [
      {
        ...
        to: { x: 3, y: 0 },
        labelKey: "x",
        labelOffset: { x: 0.22, y: -0.38 },
      },
      {
        from: { x: 3, y: -2 },
        to: { x: 0, y: -2 },
        labelKey: "reflectedYH",
        labelOffset: { x: -0.55, y: -0.22 },
      },
    ],
    resultTone: { x: "x", y: "y" },
  },
