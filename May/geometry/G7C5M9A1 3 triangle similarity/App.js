...
const App = () => {
  ...
  const hideNextButton =
    ...
    (currentStep === 3 && isNextDisabled) ||
    (currentStep === 4 && isNextDisabled) ||
    (currentStep === 5 && isNextDisabled) ||
    (currentStep === 6 && isNextDisabled) ||
    (currentStep === 7 && isNextDisabled) ||
    (currentStep === 8 && isNextDisabled);
