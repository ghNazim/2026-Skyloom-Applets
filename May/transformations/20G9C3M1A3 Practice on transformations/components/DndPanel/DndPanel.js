const DndPanel = ({
  ...
  const findZoneAtPoint = useCallback((x, y) => {
    const zones = document.querySelectorAll(".dnd-drop-zone");
    let found = null;
    zones.forEach((zone) => {
  ...
  const renderDropCard = (zoneId, title) => {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        {
          className: "dnd-drop-zone" + (isWrongTarget ? " is-wrong-drop" : ""),
          "data-zoneid": zoneId,
        },
        items.map((id) =>
          React.createElement(
        ...
        isWrongTarget
          ? React.createElement(
              ...
              APP_DATA.properties[wrongItemId].label,
            )
          : null,
      ),
    );
  ...
  const renderDragGhost = () => {
    ...
    return React.createElement(
      ...
      APP_DATA.properties[draggedItem].label,
    );
  };
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      renderDropCard("changed", APP_DATA.dnd.changedTitle),
      renderDropCard("same", APP_DATA.dnd.sameTitle),
    ),
    React.createElement(
      "div",
