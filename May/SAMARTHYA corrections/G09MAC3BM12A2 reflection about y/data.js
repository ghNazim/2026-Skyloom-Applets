    ...
    app: {
      ...
      steps: {
        ...
        4: {
          ...
          unitPlural: "{n} units",
          rightTextDone:
            "Point A(5, 4) is <y>5 units</y> away from y-axis.<br><y>Absolute value of x-coordinate of a point tells its distance from y-axis.</y><br>Now, let's recall the properties of reflection to locate the image.",
        ...
        9: {
          questions: [
            ...
            },
            {
              ...
              imageY: "0",
              topText:
                "Find coordinates of image when point B(4, 0) is reflected across y-axis.",
              options: ["4", "-4", "0"],
            },
            {
              point: "C",
    ...
    app: {
      ...
      steps: {
        ...
        4: {
          ...
          unitPlural: "{n} satuan",
          rightTextDone:
            "Titik A(5, 4) berjarak <y>5 satuan</y> dari sumbu-y.<br><y>Nilai mutlak dari koordinat-x suatu titik menunjukkan jaraknya dari sumbu-y.</y><br>Sekarang, mari ingat kembali sifat-sifat refleksi untuk menemukan bayangannya.",
          propertiesBtn: "Sifat",
        ...
        9: {
          questions: [
            ...
            },
            {
              ...
              imageY: "0",
              topText:
                "Tentukan koordinat bayangan ketika titik B(4, 0) direfleksikan terhadap sumbu-y.",
              options: ["4", "-4", "0"],
            },
            {
              point: "C",
