  ...
  en: {
    app: {
      ...
      slider: {
        zoomOut: "Zoom out",
        zoomIn: "Zoom in",
        scaleFactor: "Scale Factor(<mk>k</mk>)",
      },
      steps: {
        1: {
          questionText:
        ...
        5: {
          ...
          questionTextDone:
            "When the <y>scale factor (<mk>k</mk>) > 1</y>, the dilation produces a larger image called an <y>enlargement</y>.",
          navText:
            "Drag the slider above 1 and see how size change as per scale factor.",
          navDone: "Tap » to continue",
          rightText:
            "Change in size of image is represented with <y>scale factor</y>. The scale factor is denoted by the letter '<mk>k</mk>'.",
        },
        6: {
          questionText: "Key Elements of Dilation",
          questionTextDone:
            "When the <y>scale factor (<mk>k</mk>) = 1</y>, the image remains the same size as the original image.",
          navText:
        ...
        7: {
          ...
          questionTextAfter:
            "When the <y>scale factor is 0 < (<mk>k</mk>) < 1</y>, the dilation produces a smaller image called a <y>reduction</y>.",
          navTextAfter: "Tap » to other the key elements of dilation.",
        },
        8: {
          questionText:
            "Update the scale factor and identify the point around which the triangle changes size.",
      ...
      mcq: {
        gt1: {
          title:
            "What happens when the<br><y>scale factor(<mk>k</mk>) > 1</y>?",
          options: [
            "Enlarges triangle",
            "Reduces triangle",
      ...
      mcqNavText: "Tap the correct option",
      feedback: {
        pointWrong:
  ...
  id: {
    app: {
      ...
      slider: {
        zoomOut: "Perkecil",
        zoomIn: "Perbesar",
        scaleFactor: "Faktor Skala(<mk>k</mk>)",
      },
      steps: {
        1: {
          questionText:
        ...
        3: {
          questionText: "Segitiga telah <y>kembali ke ukuran aslinya</y>.",
          questionTextAfter:
        ...
        5: {
          ...
          questionTextDone:
            "Ketika <y>faktor skala (<mk>k</mk>) > 1</y>, dilatasi menghasilkan bayangan yang lebih besar yang disebut <y>pembesaran</y>.",
          navText:
            "Seret penggeser di atas 1 dan lihat perubahan ukuran sesuai faktor skala.",
          navDone: "Ketuk » untuk melanjutkan",
          rightText:
            "Perubahan ukuran bayangan diwakili dengan <y>faktor skala</y>. Faktor skala dinotasikan dengan huruf '<mk>k</mk>'.",
        },
        6: {
          questionText: "Elemen Kunci Dilatasi",
          questionTextDone:
            "Ketika <y>faktor skala (<mk>k</mk>) = 1</y>, bayangan tetap sama ukurannya dengan bayangan asli.",
          navText:
        ...
        7: {
          ...
          questionTextAfter:
            "Ketika <y>faktor skala 0 < (<mk>k</mk>) < 1</y>, dilatasi menghasilkan bayangan yang lebih kecil yang disebut <y>reduksi</y>.",
      ...
      mcq: {
        gt1: {
          title:
            "Apa yang terjadi ketika<br><y>faktor skala(<mk>k</mk>) > 1</y>?",
          options: [
      ...
      mcqNavText: "Ketuk opsi yang benar.",
      feedback: {
        pointWrong:
