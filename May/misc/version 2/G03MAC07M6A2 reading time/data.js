...
function buildQuestion(time, templates) {
  ...
  return {
    ...
    steps: {
      ...
      step8done: {
        characterText: fillVars(templates.steps.step8done.characterText, vars),
      },
    },
    mcq: {
...
const DATA = {
  en: {
    app: {
      ...
      summary: {
        heading: "Reading Time",
        text: "Awesome! We have learnt how to read minutes<br>when long hand points between<br>2 consecutive numbers on the clock.",
  ...
  id: {
    app: {
      ...
      summary: {
        heading: "Waktu Membaca",
        text: "Luar biasa! Kita telah belajar cara membaca menit<br>ketika jarum panjang berada di antara<br>2 angka berurutan pada jam.",
        buttonText: "ULANGI",
      },
      splash: {
        heading: "Waktu Membaca",
        step1Image: "assets/step1.png",
        step2Image: "assets/step2_id.png",
      },
      splashSteps: {
        1: {
          text: "<bl>Mari kita ingat kembali</bl>\n\nUntuk menemukan menit ketika jarum panjang menunjuk ke suatu angka, kita perlu melakukan\n<y>PENJUMLAHAN 5 BERULANG</y>.\n\nBisakah kita menggunakan perkalian untuk membaca menit?",
        },
        2: {
      ...
      questionTemplates: {
        ...
        nav: {
          tapNextReadAt:
            "Ketuk » untuk membaca angka saat jarum panjang menunjuk ke {n}.",
        },
      },
    },
  },
