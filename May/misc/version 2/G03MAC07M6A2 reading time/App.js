const App = () => {
  ...
  const [wrongNumCircle, setWrongNumCircle] = useState(null);
  ...
  const getClockProps = () => {
    ...
    if (currentStep <= 4) {
      return {
        ...
        wrongNumCircle: currentStep === 4 ? wrongNumCircle : null,
      };
    }
  ...
  if (currentStep === 1 || currentStep === 2) {
    ...
    return e(
      "div",
      { className: "applet-container smooth-page-enter", key: "splash-page-" + currentStep },
      e(Splash, {
