const MainCanvas = ({
  ...
  const renderContent = () => {
    ...
    if (stepData.isComprehend) {
      ...
      const isCutComprehend = comprehendSubstep === comprehendCutSubstepIndex;
      const cutAnim = APP_DATA.comprehend.cutAnimation || {};
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Visual, {
            imageSrc: showVisualImage && !isCutComprehend ? getImageSrc() : "",
            showAreaLabel: false,
            step: step,
            substep: comprehendSubstep,
            cutMode: isCutComprehend,
            cutVideoSrc: isCutComprehend ? cutAnim.videoSrc || "" : "",
            cutCutterSrc: isCutComprehend ? cutAnim.cutterSrc || "" : "",
            cutKey: cutVisualKey,
            onCutVideoEnded: onCutVideoEnded,
          }),
        ),
