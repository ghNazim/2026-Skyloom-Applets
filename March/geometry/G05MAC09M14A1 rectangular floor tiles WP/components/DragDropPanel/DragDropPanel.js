const DragDropPanel = ({ onComplete, onEnableNext, onUpdateNavText, imageSrc, dragDropKey, step }) => {
  ...
  const showFindings = dragDropData.showFindings !== false && stepData.showFindings !== false;
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("img", {
          ...
          alt: (APP_DATA.altTexts && (APP_DATA.altTexts.classroom || APP_DATA.altTexts.diagram)) || "",
          className: "dd-image"
        })
      ),
      React.createElement(
        ...
        !dragDropData.hideEquationLabel && dragDropData.equationLabel && React.createElement(
          "div",
        ...
        React.createElement(
          ...
          ...dragDropData.dropZones.flatMap((zone, index) => {
            const sep = index === 0 ? null : (index === 1 ? " = " : " ");
            return sep !== null ? [sep, renderDropZone(zone, index)] : [renderDropZone(zone, index)];
          })
        )
      )
    ),
    React.createElement(
      ...
      showFindings && dragDropData.findingsTitle && dragDropData.findingsList && React.createElement(
        "div",
