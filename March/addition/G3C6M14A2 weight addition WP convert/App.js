...
const App = () => {
  ...
  const handleStep5Submit = () => {
    if (resultGm === "") return;
    const gmExpectedStep5 = typeof q.gmInterim === "number" ? q.gmInterim : q.gmResult;
  ...
  else if (currentStep === 3) characterText = q.step3CharacterText || APP_DATA.steps[3].characterText;
