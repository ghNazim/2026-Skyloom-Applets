const Comprehend = ({ step, substep, onShowFloorClick }) => {
  ...
  if (step === 1) {
    ...
    const showFloorLabel = (comprehendData.showFloorButtonLabel != null) ? comprehendData.showFloorButtonLabel : "Show Floor";
    
    return React.createElement(
      "div",
      { className: "comprehend-panel comprehend-panel-with-button" + (isSubstep0 ? " has-show-floor" : "") },
      // Section Title
      React.createElement(
        "h3",
        { className: "comprehend-section-title" },
      ...
      isSubstep0 && onShowFloorClick && React.createElement(
        "button",
        {
          type: "button",
