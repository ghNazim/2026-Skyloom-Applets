...
const DATA = {
  en: {
    app: {
      ...
      questionText:
        "Mr. Budi wants to install flooring in a traditional square shaped house. Each side is 6 meters long. What is the total area of the floor to install?",
      ...
      comprehend: {
        ...
        given: {
          ...
          highlights: ["square shaped house", "Each side is 6 meters long"],
        },
        toFind: {
          title: "To Find:",
          data: ["Area of the square floor"],
          highlights: ["What is the total area of the floor to install"],
        },
      },
      ...
      dragDrop1: {
        ...
        dropZones: [
          {
            id: "zone1",
            correctAnswer: "Area of the square floor",
            placeholder: "Area of the square floor",
          },
          {
            id: "zoneEq",
            correctAnswer: "=",
          ...
          {
            id: "zone2",
            correctAnswers: ["Side Length", "Side length"],
      ...
      steps: {
        ...
        3: {
          questionText:
            "Build a mathematical sentence to find the area of the square floor.",
          navText:
  ...
  id: {
    app: {
      ...
      questionText:
        "Pak Budi ingin memasang lantai di rumah tradisional berbentuk persegi. Setiap sisinya panjangnya 6 meter. Berapa total luas lantai yang harus dipasang?",

      comprehend: {
        sectionTitle: "ANALISIS INFORMASI",
        showFloorButtonLabel: "Tampilkan Lantai",
        navTextShowFloor:
          "Ketuk 'Tampilkan Lantai' untuk melihat lantai rumah.",
        videoSrc: "assets/animate.mp4",
        imageAfterVideo: "assets/animate3.png",
        images: [
          "assets/compre1.png",
          "assets/compre2.png",
          "assets/compre3id.png",
        ],
        given: {
          title: "Diketahui:",
          data: [
          ...
          highlights: [
            "Pak Budi ingin memasang lantai di rumah tradisional berbentuk persegi",
            "Setiap sisinya panjangnya 6 meter",
          ],
        },
        toFind: {
          title: "Ditanyakan:",
          data: ["Luas lantai persegi"],
          highlights: ["Berapa total luas lantai yang harus dipasang"],
        },
      },

      splash: {
        step2: {
          image: "assets/compre3id.png",
      ...
      dragDrop1: {
        ...
        dropZones: [
          {
            id: "zone1",
            correctAnswer: "Luas lantai persegi",
            placeholder: "Luas lantai persegi",
          },
          {
            id: "zoneEq",
            correctAnswer: "=",
          ...
          {
            id: "zone2",
            correctAnswers: ["Panjang Sisi", "Panjang sisi"],
      ...
      steps: {
        ...
        3: {
          questionText:
            "Bangun kalimat matematika untuk menemukan luas lantai persegi.",
          navText:
