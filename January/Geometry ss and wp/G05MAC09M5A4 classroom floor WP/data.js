...
const DATA = {
  en: {
    app: {
      ...
      questionText:
        "A school in Bandung plans to install ceramic tiles in their classroom. The classroom is rectangular with a length of 12 meters and width of 9 meters. Each ceramic tile is 40 cm × 40 cm and costs Rp 25,000 per piece. How much will it cost to tile the entire classroom floor?",
      ...
      comprehend: {
        ...
        toFind: {
          title: "To find:",
          data: ["Total cost of tiles needed for the floor."],
          highlights: [
      ...
      splashText: {
        step4SplashText:
          "<blue>✓ Information gathered from the figure.</blue><br><yellow>Next - Let's solve the problem step by step</yellow>",
      },
      ...
      dragDrop1: {
        ...
        dropZones: [
          ...
          {
            id: "zone2",
            correctAnswers: ["Number of tiles", "Cost of one tile"],
      ...
      step3Calc: {
        ...
        mcqQuestion:
          "How can you find the number of tiles needed to cover the floor?",
        mcqOptions: [
        ...
        afterTapCalcRow:
          "Total cost = fraction(Area of floor / Area of one tile) × Cost of one tile",
      ...
      step9Final: {
        finalAnswerText:
          "So, It will cost Rp 16,875,000 to tile the entire classroom floor.",
      },
  ...
  id: {
    app: {
      ...
      questionText:
        "Sekolah di Bandung berencana memasang ubin keramik di kelas. Ruang kelas berbentuk persegi panjang dengan panjang 12 meter dan lebar 9 meter. Setiap ubin keramik berukuran 40 cm × 40 cm dan berharga Rp 25.000 per buah. Berapa biaya yang dibutuhkan untuk memasang ubin di seluruh lantai kelas?",
      comprehend: {
        ...
        navSubstep0ShowFloor:
          "Ketuk 'Tampilkan Lantai' untuk melihat lantai kelas.",
        videoShowFloor: "assets/animate.mp4",
        imageAfterVideo: "assets/animEnd.png",
        imageSubstep3Before: "assets/compre4in.png",
        videoSubstep3: "assets/scale.mp4",
        ...
        given: {
          title: "Diketahui:",
          data: [
            "Sekolah berencana memasang ubin di kelas.",
            "Panjang lantai = 12 m",
            "Lebar lantai = 9 m",
          ...
          highlights: [
            "Sekolah di Bandung berencana memasang ubin keramik di kelas",
            "panjang 12 meter",
            "lebar 9 meter",
            "40 cm × 40 cm",
            "Rp 25.000 per buah",
        ...
        toFind: {
          ...
          highlights: [
            "Berapa biaya yang dibutuhkan untuk memasang ubin di seluruh lantai kelas",
          ],
        },
      },
      splash: {
        step4: { image: "assets/compre6.png", textKey: "step4SplashText" },
      },
      splashText: {
        step4SplashText:
          "<blue>✓ Informasi dikumpulkan dari gambar.</blue><br><yellow>Selanjutnya - Mari selesaikan masalah langkah demi langkah</yellow>",
      },
      dragDrop1: {
        hideEquationLabel: true,
        dropZones: [
          {
            id: "zone1",
            correctAnswer: "Total biaya",
            placeholder: "Total biaya",
          },
          {
            id: "zone2",
            correctAnswers: ["Jumlah ubin", "Biaya satu ubin"],
      ...
      step3Calc: {
        ...
        mcqQuestion:
          "Bagaimana cara mencari jumlah ubin yang dibutuhkan untuk menutupi lantai?",
        mcqOptions: [
        ...
        afterTapCalcRow:
          "Total biaya = pecahan(Luas lantai / Luas satu ubin) × Biaya satu ubin",
        navTapOption: "Ketuk opsi yang benar.",
        navTapHighlighted:
          "Ketuk teks yang disorot untuk menulis ulang pembagian.",
      ...
      step5Calc: {
        ...
        step5Images: ["assets/h1.png", "assets/h2.png", "assets/h3.png"],
        questions: {
          q1: "Langkah 1: Cari luas lantai.",
          q2: "Langkah 2: Cari luas satu ubin.",
          q3: "Langkah 3: Substitusi biaya satu ubin.",
        },
        navUseNumpad:
          "Gunakan numpad untuk mengisi kotak dan klik ✓ untuk memeriksa.",
        navTapContinue: "Ketuk » untuk melanjutkan.",
      ...
      step8Calc: {
        ...
        numpadMaxLength: 8,
        navUseNumpad:
          "Gunakan numpad untuk mengisi jawaban dan klik ✓ untuk memeriksa.",
        navTapContinue: "Ketuk » untuk melanjutkan.",
      },
      step9Final: {
        finalAnswerText:
          "Jadi, Biaya untuk memasang ubin di seluruh lantai kelas adalah Rp 16.875.000.",
      },
      labels: {
        given: "Diketahui",
        toFind: "Ditanyakan",
        ...
        areaOfOneTile: "Luas satu ubin",
        costOfOneTile: "Biaya satu ubin",
        simplifyButton: "Sederhanakan",
        totalCost: "Total biaya",
      },
      altTexts: {
        classroom: "Lantai kelas",
        diagram: "Diagram",
      ...
      steps: {
        0: {
          questionText:
            "Baca pertanyaan dan identifikasi 'diketahui' dan 'ditanyakan'.",
        ...
        2: {
          questionText: "Bangun kalimat matematika untuk total biaya.",
          navText: "Seret tombol yang benar ke tempat yang tepat.",
          navTextCorrect: "Ketuk » untuk melanjutkan.",
          image: "assets/compre6.png",
          isDragDrop: true,
          dragDropKey: "dragDrop1",
