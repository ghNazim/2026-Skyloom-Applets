...
const DATA = {
  en: {
    app: {
      ...
      areaCoveredByCan: "Area covered by 1 can = 1.5 m²",
      areaPaintedByCan: "Area painted by 1 can = 1.5 m²",
      costOfCan: "Cost of 1 can = Rp 22,500.00",
      ...
      compute2Config: {
        ...
        steps: [
          ...
          { delay: 1500, highlightRow1: "numerator", row2Num: "20.76 m²", row2Den: "Area painted by 1 Can", row2ColoredNum: true },
          { delay: 1500, highlightRow1: "denominator", row2Num: "20.76 m²", row2Den: "1.5 m²", row2ColoredDen: true },
          { delay: 1500, row2Replace: "13.84", appendInfoText: "Number of cans of paint = 13.84", final: true }
        ]
      },
      ...
      mcq7: {
        ...
        feedbacks: [
          ...
          "That's right! Paint can only be bought in count of full cans of paint! Total cost = Rp. 315,000.00"
        ],
        defaultImage: "assets/compute2.svg",
        correctImage: "assets/compute2.svg",
      ...
      steps: {
        ...
        11: {
          questionText: "How many cans of paint would be needed for painting the complete wall?",
          navText: "",
          isMcq: true,
          mcqKey: "mcq6",
          nextEnabled: false
  ...
  id: {
    app: {
      ...
      areaCoveredByCan: "Luas yang dapat ditutup 1 kaleng = 1,5 m²",
      areaPaintedByCan: "Luas yang dapat dicat 1 kaleng = 1,5 m²",
      costOfCan: "Harga 1 kaleng = Rp 22.500,00",
      ...
      comprehend: {
        ...
        infoList: [
          "Pada trapesium ABCD, AD = DC = CB = 4m",
          "lineAreaCoveredCan",
          "lineCostCan",
          "Total biaya pengecatan dinding = ?"
        ],
        highlights: [
      ...
      mcq: {
        title: "Apa yang perlu kita cari untuk mendapatkan total biaya pengecatan dinding?",
        options: [
          "Keliling dinding",
          "Panjang dinding",
          "Luas dinding"
      ...
      onlyText: {
        step3: {
          initialText: "Kita membutuhkan tinggi dan\npanjang kedua alas\nuntuk menghitung\nluas trapesium.",
      ...
      mcq4: {
        ...
        options: [
          "Alas: 4 m, 4 m; tinggi: 2√3 m",
          "Alas: 4 m, 8 m; tinggi: 4 m",
          "Alas: 4 m, 8 m; tinggi: 2√3 m"
        ],
        correctIndex: 2,
        feedbacks: [
      ...
      compute2Config: {
        ...
        steps: [
          { delay: 0, row1Fraction: true, rowsCount: 1 },
          { delay: 800, row2Fraction: true },
          { delay: 1500, highlightRow1: "numerator", row2Num: "20,76 m²", row2Den: "Luas yang dicat 1 Kaleng", row2ColoredNum: true },
          { delay: 1500, highlightRow1: "denominator", row2Num: "20,76 m²", row2Den: "1,5 m²", row2ColoredDen: true },
          { delay: 1500, row2Replace: "13,84", appendInfoText: "Jumlah kaleng cat = 13,84", final: true }
        ]
      },
      ...
      mcq7: {
        ...
        feedbacks: [
          ...
          "Benar! Cat hanya dapat dibeli dalam jumlah kaleng utuh! Total biaya = Rp. 315.000,00"
        ],
        defaultImage: "assets/compute2.svg",
        correctImage: "assets/compute2.svg",
      ...
      steps: {
        ...
        1: { questionText: "", navText: "", isMcq: true, mcqKey: "mcq", nextEnabled: false },
        2: { questionText: "", navText: "", isSplash: true, splashKey: "step2", nextEnabled: true },
        3: { questionText: "", navText: "", isOnlyText: true, onlyTextKey: "step3", isPerpendiculars: true, nextEnabled: false },
        4: { questionText: "Bandingkan segitiga", navText: "", isMcq: true, mcqKey: "mcq2", nextEnabled: false },
        5: { questionText: "Jenis segitiga apa ini", navText: "", isMcq: true, mcqKey: "mcq3", nextEnabled: false },
        6: { questionText: "Cari panjang sisi menggunakan perbandingan sisi", navText: "", isTable: true, tableKey: "tableStep", nextEnabled: false },
        7: { questionText: "Berapa dimensi trapesium?", navText: "", isMcq: true, mcqKey: "mcq4", nextEnabled: false },
        8: { questionText: "Berapa luas trapesium?", navText: "", isMcq: true, mcqKey: "mcq5", nextEnabled: false },
        9: { questionText: "Berapa luas trapesium?", navText: "", isCompute: true, computeKey: "compute1Config", nextEnabled: false },
        10: { questionText: "", navText: "", isSplash: true, splashKey: "step10", nextEnabled: true },
        11: {
          questionText: "Berapa kaleng cat yang dibutuhkan untuk mengecat seluruh dinding?",
          navText: "",
          isMcq: true,
          mcqKey: "mcq6",
          nextEnabled: false
...
APP_DATA.listLineKeys = ["lineAreaCoveredCan", "lineCostCan", "lineAreaPaintedCan"];
