const VisualPanel = ({
  ...
  useEffect(() => {
    if (step === 3) {
      ...
      const animateWipe = () => {
        ...
        setWipeProgress(p);
        if (p < 1) requestAnimationFrame(animateWipe);
      };
      ...
      label &&
        React.createElement(
          "text",
          {
            ...
            onClick: step === 4 ? (e) => handleLabelClick(e, label) : null,
          },
          label
        ),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      // Step 3: Points on line (vanishing animation) - Calculated dynamically to handle remount/drag
      step === 3 &&
        wipeProgress < 1 &&
        (() => {
          const numPoints = 11;
      ...
      (step === 3 || step === 4 || step === 5) &&
        React.createElement("line", {
          ...
          y2: pointBPos.y,
          stroke: "white",
          strokeWidth: step === 4 && showLineClickHint && lineHovered ? 2 : 1.2,
          strokeDasharray:
            step === 3 && wipeProgress < 1
              ? getDistance(pointAPos.x, pointAPos.y, pointBPos.x, pointBPos.y)
              : "none",
          strokeDashoffset:
            step === 3 && wipeProgress < 1
              ? getDistance(
