const MainCanvas = ({ 
  ...
  const renderContent = () => {
    ...
    // Steps 3-14: Calculation Panel (includes MCQ + calculation, interactive boxes, numpad, final step)
    if (stepData.isInteractiveBoxes || stepData.isNumpad || stepData.isMcq || stepData.isFinalStep || stepData.isCalculation) {
