const DragDropPanel = ({ onComplete, onEnableNext, onUpdateNavText, imageSrc, dragDropKey, step }) => {
  ...
  // Reset state when dragDropKey or step changes
  useEffect(() => {
    setFilledZones({});
  ...
  return React.createElement(
    ...
    { className: "drag-drop-panel" },
      // Left column - Image/Question and Equation
    React.createElement(
      "div",
      { className: "dd-left-column" },
      // Image row or Question row
      dragDropData.showQuestionInsteadOfImage
        ...
        : React.createElement(
            ...
            React.createElement("img", {
              ...
              alt: (APP_DATA.calculation && APP_DATA.calculation.altTexts) ? (dragDropData.altTextImage && APP_DATA.calculation.altTexts[dragDropData.altTextImage] || APP_DATA.calculation.altTexts.stones) : "Image",
              className: "dd-image"
            })
          )
      ,
        ...
        React.createElement(
          ...
          dragDropData.equationLineParts
            ...
            : (() => {
                ...
                const out = [pre];
                zones.forEach((z, i) => { if (i) out.push(" "); out.push(z); });
                return out;
              })()
        )
      )
    ),
    // Right column - Findings div (optional) + Draggables
    React.createElement(
      "div",
      { className: "dd-right-column" },
      // Findings div on top (only when showFindings and has list)
      dragDropData.showFindings && dragDropData.findingsList && dragDropData.findingsList.length > 0
        ? React.createElement(
            "div",
            { className: "dd-findings-div" },
            React.createElement("div", { className: "dd-findings-title" }, dragDropData.findingsTitle || (APP_DATA.labels && APP_DATA.labels.findings) || "Findings"),
            React.createElement(
              "ul",
