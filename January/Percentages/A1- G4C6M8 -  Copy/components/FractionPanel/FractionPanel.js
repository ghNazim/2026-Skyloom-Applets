const FractionPanel = ({
  ...
  const arrowRightToLeftUpper = showArrowRightToLeft && React.createElement(
    ...
    React.createElement("path", {
      d: "M 14 42 L 14 15 L 72 15 L 72 34", // Up from right, left, down to left
  ...
  const arrowRightToLeftLower = showArrowRightToLeft && React.createElement(
    ...
    React.createElement("path", {
      d: "M 24 59 L 24 85 L 88 85 L 88 72", // Down from right, left, up to left
  ...
  const renderBreakdown = () => {
    ...
    const labelTenthsClass = `grey box-label-4 ${activeLabels ? "active" : ""} ${highlightTenths ? "label-highlight" : ""}`;
    ...
    if (groupedBreakdown) {
       ...
       return React.createElement("div", { className: "breakdown-container-4" },
          React.createElement("div", { className: "decimal-box-4-wrapper ones-box" },
             ...
             React.createElement("div", { className: "box-label-4 ones-label grey" }, APP_DATA.labels.ones)
          ),
          decimalPointElement,
