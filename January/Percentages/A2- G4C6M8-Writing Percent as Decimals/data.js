    ...
    app: {
      ...
      steps: {
        1: {
          ...
          questionTextCorrect:
            "<y>27</y> shaded squares <y>out of 100</y> represent <y>27 hundredths</y>.",
          ...
          mcq: {
            options: ["0.37", "2.7", "0.27", "2.07"],
            answer: "0.27",
            feedbacks: {
              correct:
                "Great job!<br>Each shaded square is one hundredth.<br>27 hundredths = 0.27.",
              wrong:
                "Not quite!<br>Each small square is one hundredth.<br>Count the shaded hundredths and try again.",
            },
          },
        },
        2: {
          questionText:
            "The <y>hundredths place</y> shows how many parts <y>out of 100</y> are there, which is the <y>Percent</y>.",
        ...
        3: {
          questionText:
            "The <y>number of hundredths</y> becomes the <y>number</y> before the % sign.",
        ...
        4: {
          questionText:
            "The <y>number before the %</y> tells how many <y>hundredths</y>.<br>“<y>Hundredths</y>” means <y>out of 100</y>.",
        ...
        5: {
          ...
          feedbacks: {
            correct:
              "Awesome!<br>There are <n> hundredths in the given decimal,<br>which represents <p>.",
            wrong:
              "Not quite!<br>The decimal shows <n> hundredths. Each hundredth is one percent.",
          },
        },
      },
      labels: {
    ...
    app: {
      ...
      steps: {
        1: {
          ...
          questionTextCorrect:
            "<y>27</y> kotak yang diarsir <y>dari 100</y> mewakili <y>27 perseratus</y>.",
          ...
          mcq: {
            ...
            feedbacks: {
              correct:
                "Kerja bagus!<br>Setiap kotak yang diarsir adalah satu perseratus.<br>27 perseratus = 0,27.",
              wrong:
                "Kurang tepat!<br>Setiap kotak kecil adalah satu perseratus.<br>Hitung perseratus yang diarsir dan coba lagi.",
            },
          },
        },
        2: {
          questionText:
            "<y>Tempat perseratus</y> menunjukkan ada berapa bagian <y>dari 100</y>, yang merupakan <y>Persen</y>.",
        ...
        3: {
          questionText:
            "<y>Jumlah perseratus</y> menjadi <y>angka</y> sebelum tanda %.",
        ...
        4: {
          questionText:
            "<y>Angka sebelum %</y> memberitahu berapa banyak <y>perseratus</y>.<br>“<y>Perseratus</y>” berarti <y>dari 100</y>.",
          navText:
            "Ketuk » untuk menyajikan lebih banyak desimal sebagai Persen.",
          filledSquares: 27,
        ...
        5: {
          ...
          feedbacks: {
            correct:
              "Luar biasa!<br>Ada <n> perseratus dalam desimal yang diberikan,<br>yang mewakili <p>.",
            wrong:
              "Kurang tepat!<br>Desimal menunjukkan <n> perseratus. Setiap perseratus adalah satu persen.",
          },
        },
      },
      labels: {
