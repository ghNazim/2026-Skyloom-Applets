...
const SphereStill = () => {
  ...
  useEffect(() => {
    ...
    const sR = 1.2 * 1.1; // sphere radius (10% increase, ~1.32)
    ...
    const updateLabels = () => {
      ...
      // ==============================
      // RECTANGLE LABELS (right side) - width sky blue, height yellow
      // ==============================
