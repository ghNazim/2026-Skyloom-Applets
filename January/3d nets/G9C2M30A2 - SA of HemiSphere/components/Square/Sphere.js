...
const SPHERE_RADIUS = 1.5 * 1.15; // 1.725 (15% increase)
...
const SphereVisual = ({ step, onAnimationComplete }) => {
  ...
  useEffect(() => {
    ...
    const updateLabels = () => {
      ...
      // Light pink (width/circumference) and yellow (height) markers
      defs.appendChild(
      ...
      const circlePath3D = (centerY, radius, color = "#FFB6C1", strokeWidth = 3) => {
        const segments = 64;
        const points = [];
      ...
      // ==============================================================
      // STEP 2: Sphere labels (r above, 2r on right) - height yellow
      // ==============================================================
      if (cs === 2) {
        // Radius dashed line above sphere (white)
        dashedLine(
      ...
      // Circumference of top circular base + "2πr" label left of it; height yellow
      // ==============================================================
      if (cs === 3 && state.morphInfluence <= 0.01) {
        // Highlight circumference of top circular base (light pink)
        circlePath3D(h / 2, r, "#FFB6C1", 3);
        ...
        // Radius line on top circle (white)
        solidLine(
      ...
      // Width/line light pink, height yellow
      // ==============================================================
      if (cs === 4 && state.unfoldProgress >= 0.99) {
        // Highlight top edge of rectangle (circumference, light pink)
        solidLine(
