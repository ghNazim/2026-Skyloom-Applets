  ...
  en: {
    app: {
      start: {
        ...
        text: "Let us learn how <y>decimal numbers</y> are written as<br><y>mixed numbers</y>.",
        buttonText: "Start",
      },
      steps: {
        1: {
          questionText: "Let us convert this <y>decimal number</y> into a <y>mixed number</y>.",
        ...
        2: {
          questionText: "Identify the <y>decimal part</y>.",
        ...
        3: {
          questionText: "What is the fractional form of <y>0.25</y> ?",
        ...
        5: {
          questionText: "Express the <y>whole part</y> and <y>fractional part</y> as mixed number.",
      ...
      step7Final: {
        heading: "Decimal Numbers to Mixed Numbers",
        text: "<left>Awesome!<br>To write the given decimal number as mixed number:<br>● Whole part → stays the same<br>● Decimal part → becomes a fraction<br>● Write the simplest form of the fractional part.<br>● Combine the <y>whole part</y> and <y>fractional part</y> to make the <y>mixed number</y>.</left>",
      ...
      questions: [
        {
          ...
          mixedNumerator: "1",
          mixedDenominator: "5",
          questionTextStep2: "<y>Step 01</y>: Identify the decimal part.",
          questionTextStep3: "<y>Step 02</y>: Write the decimal part as a fraction.",
          questionTextStep4: "<y>Step 03</y>: Simplify the fractional part.",
          questionTextStep5: "<y>Step 04</y>: Express the <y>whole part</y> and <y>fractional part</y> as mixed number.",
          questionTextStep5Complete: "<y>Step 04</y>: Express the <y>whole part</y> and <y>fractional part</y> as mixed number.",
  ...
  id: {
    app: {
      start: {
        ...
        text: "Mari kita pelajari bagaimana <y>bilangan desimal</y> ditulis sebagai<br><y>bilangan campuran</y>.",
        buttonText: "Mulai",
      },
      steps: {
        1: {
          questionText: "Mari kita ubah <y>bilangan desimal</y> ini menjadi <y>bilangan campuran</y>.",
        ...
        2: {
          questionText: "Identifikasi <y>bagian desimal</y>.",
        ...
        3: {
          questionText: "Apa bentuk pecahan dari <y>0,25</y> ?",
        ...
        5: {
          questionText: "Nyatakan <y>bagian bulat</y> dan <y>bagian pecahan</y> sebagai bilangan campuran.",
      ...
      step7Final: {
        heading: "Bilangan Desimal ke Bilangan Campuran",
        text: "<left>Luar biasa!<br>Untuk menulis bilangan desimal sebagai bilangan campuran:<br>● Bagian bulat → tetap sama<br>● Bagian desimal → menjadi pecahan<br>● Tulis bentuk paling sederhana dari bagian pecahan.<br>● Gabungkan <y>bagian bulat</y> dan <y>bagian pecahan</y> untuk membuat <y>bilangan campuran</y>.</left>",
      ...
      questions: [
        {
          ...
          mixedNumerator: "1",
          mixedDenominator: "5",
          questionTextStep2: "<y>Langkah 01</y>: Identifikasi bagian desimal.",
          questionTextStep3: "<y>Langkah 02</y>: Tulis bagian desimal sebagai pecahan.",
          questionTextStep4: "<y>Langkah 03</y>: Sederhanakan bagian pecahan.",
          questionTextStep5: "<y>Langkah 04</y>: Nyatakan <y>bagian bulat</y> dan <y>bagian pecahan</y> sebagai bilangan campuran.",
          questionTextStep5Complete: "<y>Langkah 04</y>: Nyatakan <y>bagian bulat</y> dan <y>bagian pecahan</y> sebagai bilangan campuran.",
