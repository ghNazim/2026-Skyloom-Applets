const MainCanvas = ({
  ...
  const renderObjectCards = () => {
    const objects = ["stone", "anchor", "brick"];
    const titles = APP_DATA.objectTitles || { stone: "Stone", anchor: "Anchor", brick: "Brick" };
    ...
    return React.createElement(
      ...
      objects.map((obj) => {
        ...
        return React.createElement(
          ...
          React.createElement("div", { className: "object-card-content" },
            React.createElement("div", { className: "object-card-title" }, titles[obj] || obj),
  ...
  // Step 1: Show SVG canvas + Object cards + slider in left panel
  if (step === 1) {
    return React.createElement(
      "div",
        ...
        currentObject &&
          React.createElement(
            ...
            React.createElement("input", {
              ...
              onChange: (e) => onDropProgressChange && onDropProgressChange(parseFloat(e.target.value)),
            })
          )
      ),
