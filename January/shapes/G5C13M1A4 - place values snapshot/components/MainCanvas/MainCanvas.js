...
const MainCanvas = ({
  ...
  const getEnabledButton = () => {
    ...
    if (maxCompleted >= 4) return -1; // all done
  ...
  useEffect(() => {
    if (activeStep < 0 || activeStep > 4) return;
