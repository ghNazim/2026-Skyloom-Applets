const DATA = {
    ...
    questions: [
...

      {
        intro: {
          ...
          text: "Here is a die on which<br>we have 6 on all six faces.<br><br>If we roll this die,<br><y>how likely is it that we get a '6'?</y><br><br>Tap 'Continue' to explore.",
          buttonText: "Continue",
        },
...

      {
        intro: {
          ...
          text: "We have a die <br>with six faces as shown.<br>If we roll this die,<br><y>how likely is it that we get<br>a particular number?</y><br><br>Tap 'Continue' to explore.",
          buttonText: "Continue",
        },
  ...
  id: {
    scalePositions: [
      { label: "TIDAK MUNGKIN", dotColor: "#e53935" },
      { label: "KURANG MUNGKIN", dotColor: "#fb8c00" },
      { label: "MUNGKIN", dotColor: "#fdd835" },
      { label: "SANGAT MUNGKIN", dotColor: "#29b6f6" },
      { label: "PASTI", dotColor: "#66bb6a" },
    ],

    correctTemplates: {
      1: "Benar! Jumlah {coloredItem} adalah 0.\n0 = Tidak Mungkin",
    ...
    questions: [
      {
        ...
        leftPanelImage: "assets/bookshelf.png",
        title: "",
        instruction: "Hitung jumlah masing-masing buku\ndan letakkan pada skala.",
        heading:
...

      {
        ...
        leftPanelImage: "assets/bag1.png",
        title: "",
        instruction: "Hitung jumlah bola untuk\nsetiap warna dan\nletakkan di skala.",
        heading:
          "<y>Perkirakan probabilitas</y> dengan benar menggunakan skala ini.",
        placeholderImage: "assets/ballPlaceholder.png",
        maxPerZone: 3,
    ...
    final: {
      ...
      text: "Kalian memperkirakan probabilitas dengan benar!<br>Kalian sekarang dapat menggunakan skala dan mengetahui apakah suatu kejadian<br><y>tidak mungkin, kurang mungkin, mungkin, sangat mungkin, atau pasti!</y><br><br><br>Ketuk 'Ulangi' untuk mengulangi aktivitas ini.",
      buttonText: "Ulangi",
    },
  },
};
