const DATA = {
  en: {
    ...
    comprehend: {
      ...
      navStep2Start: "Let\u2019s note the information from the question.",
  ...
  id: {
    ...
    comprehend: {
      questionText:
        'Ada <span class="yellow">10 bola dalam sebuah tas</span>.<br>Ketika satu bola diambil secara acak, peluang<br>mengambil bola dari setiap warna ditunjukkan pada skala<br>probabilitas di bawah ini.<br>Berdasarkan skala probabilitas ini, <span class="light-blue">perkirakan berapa banyak<br>bola dari setiap warna yang ada dalam tas</span>.',
